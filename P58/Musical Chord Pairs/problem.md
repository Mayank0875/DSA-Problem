...
## Description
A composer is experimenting with frequencies. A 'Perfect Chord' is defined as two notes played together whose frequencies sum up to a specific harmonic target. Given a list of available note frequencies, determine how many pairs of notes produce a Perfect Chord.
