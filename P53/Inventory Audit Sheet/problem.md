...
## Description
An audit list contains item counts (non-zero) and 'out of stock' entries (`0`). The auditor rewrites the list to show all in-stock items at the top, maintaining their order, with all out-of-stock entries moved to the bottom.
