...
## Description
You set up dominoes in a line. To reset them exactly as they were after they fall, you must stand them up in reverse order of their fall.

The data is stored as a string `s`. To reset the dominoes, you must reverse the string.
