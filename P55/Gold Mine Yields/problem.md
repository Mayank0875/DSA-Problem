...
## Description
A mining corporation tracks the daily yield of several mines. Mines producing an even tonnage of gold are taxed at a special rate based on their output. As production numbers fluctuate, calculate the total yield from all mines currently subject to this special tax.
