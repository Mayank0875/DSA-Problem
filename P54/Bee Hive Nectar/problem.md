...
## Description
A honeycomb grid contains different types of nectar. A bee needs to collect a specific blend by visiting adjacent cells in a specific order. Determine if the bee can collect the required nectar blend from the hive.
