...
## Description
An elevator optimizes stops. Even stops are sorted by floor priority ascending. Odd stops are sorted by floor priority descending. Given the priority values, schedule the stops.
