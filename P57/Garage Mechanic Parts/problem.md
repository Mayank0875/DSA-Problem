...
## Description
A mechanic has a bin of spare parts. They have a list of repairs to perform. A repair can be completed if the bin has all the specific parts. Calculate the total part count of all feasible repairs.
