...
## Description
Time flows forward, but flipping a magical hourglass reverses the flow of entropy strings.

The data is stored as a string `s`. To invert the entropy, you must reverse the string.
