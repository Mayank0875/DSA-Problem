...
## Description
A logistics hub has containers of various standard volumes, sorted by size. A client has a cargo shipment of a specific total volume. The hub manager needs to select the smallest container that is large enough to hold the cargo. Find the index of the first container with volume >= cargo volume.
