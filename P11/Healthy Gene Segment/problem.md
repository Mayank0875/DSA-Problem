...
A biologist is examining a DNA strand of length N. A '1' represents a healthy gene, and a '0' represents a mutated gene. A "viable segment" is a contiguous part of the strand that contains at most `k` mutated genes. You must find the length of the longest viable gene segment for further study.
