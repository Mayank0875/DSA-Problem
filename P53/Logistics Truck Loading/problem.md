...
## Description
A delivery truck is loaded with boxes (non-zero dimensions). Gaps (`0`) appear as boxes are removed. The driver slides the remaining boxes forward to prevent shifting during transit, leaving the empty space at the rear door.
