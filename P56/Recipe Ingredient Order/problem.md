...
## Description
Two ancient recipes list ingredients in a specific order. A historian wants to find the longest continuous sequence of ingredients that is the same in both, suggesting a common origin recipe. Find the length of this sequence.
