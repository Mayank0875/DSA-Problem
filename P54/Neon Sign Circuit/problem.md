...
## Description
A neon sign is composed of a grid of gas tubes. To animate it, the controller activates tubes in a sequence. The activation moves to adjacent tubes. Determine if the desired animation sequence is physically possible.
