...
## Description
An astronomer checks how many ways a constellation pattern fits into a map of the night sky stars.

You are given two strings `target` and `source` consisting of star types.
