...
## Description
An automated fruit packing machine sorts apples by weight. The weights are recorded in a sorted list. The packing manager needs to verify the machine's calibration by counting how many apples weighed exactly a target amount.
