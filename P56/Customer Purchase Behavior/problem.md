...
## Description
A retailer compares the shopping history of two customers, represented as a sequence of product IDs bought in order. They want to find the longest continuous streak of identical purchases to identify shared habits. Find the length of this streak.
