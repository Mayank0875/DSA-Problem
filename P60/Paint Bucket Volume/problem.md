...
## Description
A painter organizes supplies. Even buckets are sorted by volume ascending. Odd buckets are sorted by volume descending. Given the volumes, arrange the buckets.
