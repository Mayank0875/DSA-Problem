...
## Description
A truck runs out of k servings. Servings are by dish ID. They run out of the limited specials first. Calculate the minimum number of unique dishes still available.
