...
## Description
An inspector checks elevators. Limits must match. Limits can be upgraded by integer factors.

You have two lists of weight limits.

In a single upgrade, The inspector can:
...
The inspector wants to make the lists identical (i.e., $a_i = b_i$ for all $1 \le i \le n$) using the **minimum** number of upgrades.
