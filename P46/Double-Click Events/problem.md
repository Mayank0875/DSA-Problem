...
## Description
A UI testing framework logs button IDs when clicked. A 'double-click' action generates two log entries. The tester wants to verify which buttons were double-clicked. Given the log of button IDs, return the IDs that appear exactly twice.
