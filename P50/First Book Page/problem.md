...
## Description
A digital index lists page numbers where a specific keyword appears, sorted in order. A reader wants to jump to the very first mention of the keyword on a specific target page (if multiple mentions exist on that page, they are listed sequentially). Find the index of the first entry for the target page.
