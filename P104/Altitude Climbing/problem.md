...
## Description
A climber records elevation points reached. A 'smooth ascent' is a set of elevation points that are consecutive integers.

Given an unsorted array of integers `elevations` representing the elevation points, return the length of the longest consecutive sequence of points that can be mapped as a smooth ascent.
