...
## Description
To detect sustained viral trends rather than one-hit wonders, a platform averages the engagement metrics of a post with those posted shortly before and after it.

You are given a **0-indexed** array `nums` of `n` integers representing engagement scores and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of engagement scores.
