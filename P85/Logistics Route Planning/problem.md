...
## Description
A delivery company has `n` routes with different distances. A driver's schedule is valid if the distances of their assigned routes have a GCD of 1.

Your task:
Count how many non-empty subsequences of routes have a greatest common divisor (GCD) of their distances exactly equal to 1.
...
## Input Format
- The first line contains an integer n (the number of routes).
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the distances.
