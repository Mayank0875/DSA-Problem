...
## Description
A musical interface is a grid of buttons playing notes. A musician wants to play a specific melody by pressing adjacent buttons in sequence. Check if the melody can be played on this interface.
