...
## Description
A player drops k items to free up slots. Items are by type ID. They drop the junk items they only have one of. Calculate the minimum number of unique item types left in the inventory.
