...
## Description
A yoyo goes down and must come back up. The string winds and unwinds in reverse patterns.

The data is stored as a string `s`. To complete the trick, you must reverse the string.
