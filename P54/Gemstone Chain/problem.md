...
## Description
A jeweler is designing a necklace from a grid of loose gems. They want to string together a specific sequence of gems by picking adjacent stones. Check if the desired necklace pattern can be created from the tray.
