...
## Description
A zookeeper lists animals by weight class. Rare weight classes in the zoo population should be fed first. If the count of animals is the same for two classes, the heavier class comes first.
