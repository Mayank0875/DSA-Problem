...
## Description
A weather balloon records data. Scientists look for a specific 'Temp-Pressure-Humidity' profile in the ascent log.

You are given two strings `target` and `source` consisting of sensor codes.
...
- Strings consist of sensor codes.
