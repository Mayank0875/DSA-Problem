...
## Description
A librarian has `n` books with unique ISBN checksums. A special exhibit features a collection of books where the GCD of their checksums is 1.

Your task:
Count how many non-empty subsequences of books have a greatest common divisor (GCD) of their checksums exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the checksums.
