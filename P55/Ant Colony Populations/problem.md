...
## Description
An entomologist tracks ant colonies. Colonies with an even population are in a 'growth phase'. As ants migrate or hatch, calculate the total population of all colonies currently in the growth phase.
