...
## Description
A factory tracks widgets produced per minute. A smoothed average helps identify bottlenecks in the assembly line.

You are given a **0-indexed** array `nums` of `n` integers representing widget counts and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of widget counts.
