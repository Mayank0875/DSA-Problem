...
## Description
A smart light dims to off. The controller reduces brightness lumens by any digit present in the current brightness value.

The brightness currently has a value of $n$. To turn off the lights, you must reduce this value exactly to $0$.
