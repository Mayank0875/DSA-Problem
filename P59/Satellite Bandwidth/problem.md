...
## Description
Companies trade satellite bandwidth allocation. The price per terabyte varies. You want to buy allocation and sell it later. Given the daily spot prices, determine the maximum profit.
