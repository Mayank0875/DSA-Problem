...
## Description
A site manager clears k truckloads of debris. Debris is by type ID (wood, concrete, etc.). They clear the small piles first. Find the minimum number of unique debris types left on site.
