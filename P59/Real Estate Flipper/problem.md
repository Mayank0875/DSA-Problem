...
## Description
A property speculator tracks the market value of a house over a sequence of months. To maximize returns, they want to purchase the property in one month and sell it in a subsequent month. Given the monthly valuation reports, calculate the maximum profit achievable.
