...
## Description
A geological survey lists earthquake magnitudes sorted by severity. A researcher wants to find the first recorded event with a specific magnitude. Given the sorted list of magnitudes, return the index of the first occurrence of the target magnitude.
