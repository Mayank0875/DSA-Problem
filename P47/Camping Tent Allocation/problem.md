...
## Description
A scout troop is setting up camp. The tents available are 2-person tents with a weight rating for gear and occupants. Given the total weight (person + gear) for each scout, determine the minimum number of tents required to shelter everyone.
