...
## Description
A blockchain ledger is verified from the most recent block back to the genesis block.

The data is stored as a string `s`. To audit the chain, you must reverse the string.
