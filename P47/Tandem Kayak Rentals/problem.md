...
## Description
A riverside rental shop has a fleet of kayaks. Each kayak is designed for at most two people and has a maximum weight capacity to stay afloat safely. You are given the weights of a group of tourists. Calculate the minimum number of kayaks needed to get the entire group onto the water.
