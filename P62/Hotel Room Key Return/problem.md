...
## Description
A hotel cleans k keys returned. Keys are by floor ID. They process the floors with few checkouts first. Calculate the minimum number of unique floors represented by the remaining uncleaned keys.
