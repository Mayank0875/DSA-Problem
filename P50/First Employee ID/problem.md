...
## Description
An HR database lists active employee IDs sorted numerically. An administrator needs to find the record index of the first employee with a specific ID. Given the sorted list of IDs, find the index of the first occurrence of the target ID.
