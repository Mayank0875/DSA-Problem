...
## Description
A runway show line-up is set. Even positions are for models sorted by height ascending. Odd positions are for models sorted by height descending. Given the heights, arrange the line-up.
