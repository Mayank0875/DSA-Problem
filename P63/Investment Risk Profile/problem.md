...
## Description
An investor builds a portfolio of $n$ assets. There are 5 risk categories (1-5). To maintain a specific risk curve, the assets in the portfolio list must be sorted by risk level in ascending order. How many distinct risk profiles can the portfolio have?
