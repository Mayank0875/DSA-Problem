...
## Description
A DJ organizes a setlist. Even track numbers should increase in tempo (BPM ascending). Odd track numbers should decrease in tempo (BPM descending). Given the BPMs of the songs, create the playlist.
