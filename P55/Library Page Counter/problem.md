...
## Description
A digital library tracks the number of pages in various e-books. A special reading challenge only counts pages from books with an even number of pages. As editors update book lengths (adding or removing pages), you need to report the total page count of all qualifying (even-paged) books after each edit.
