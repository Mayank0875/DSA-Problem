...
## Description
A factory has a stock of sensors and motors. There are orders for different robot models. A model can be assembled if the stock has all the required components. Calculate the total component count of all assemblable robots.
