...
Infinite Loopstorm: Next Higher Surge
...
During an endless Loopstorm, each vortex is measured by its intensity level. For every vortex, the storm analysts want to know the intensity of the nearest future vortex that is strictly stronger. This information helps them predict the storm’s escalation pattern and identify the most powerful surges. If there is no later vortex with a higher intensity (either because it is the final vortex or all subsequent vortices are weaker or equal), this should be indicated. Can you compute this for each vortex?
