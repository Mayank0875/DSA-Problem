...
## Description
A baker has applied frosting to the side of a cake, but it is uneven, forming vertical ridges of different heights. To make a perfect design, the baker wants to smooth out a rectangular region. Find the maximum area of a rectangle that can be smoothed out within the existing frosting profile.
