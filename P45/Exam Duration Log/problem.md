...
## Description
An online testing platform records the time taken by students to complete a test, sorted by duration. The exam board wants to know how many students finished in exactly the target time.
