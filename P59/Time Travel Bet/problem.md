...
## Description
A time traveler looks at a historical record of betting odds. They want to place a bet (buy) and cash out (sell) later. Given the odds (prices) over time, find the maximum gain.
