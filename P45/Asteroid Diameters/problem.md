...
## Description
An astronomical database lists the diameters of discovered asteroids, sorted by size. A scientist studying a specific class of asteroids needs to count how many have a diameter equal to a target value.
