...
## Description
A digital dictionary stores words in lexicographical order (represented here by integer hashes). When a user types a search term, the autocomplete feature needs to jump to the first word in the database that is lexicographically greater than or equal to the search term. Return the index of this word.
