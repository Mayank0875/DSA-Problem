...
## Description
Two robotic assembly lines report their operation codes as integer sequences. An engineer wants to find the longest continuous sequence of operations that both robots performed identically. This helps in standardizing the process. Find the matching sequence length.
