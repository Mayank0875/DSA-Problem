...
## Description
An archaeologist tries to decipher a clay tablet grid. A sentence is formed by reading adjacent symbols. Given the symbol grid and a possible sentence, determine if the sentence appears on the tablet.
