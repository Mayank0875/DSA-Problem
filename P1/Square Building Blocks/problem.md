...
An architect has blocks numbered L to R. Only blocks with a perfect square number are stable enough for a foundation. Count how many stable blocks are in this range.
