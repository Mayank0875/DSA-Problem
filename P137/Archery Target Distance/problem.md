...
## Description
A coach sets up targets. Distances must match. Distances can be increased by integer factors.

You have two lists of distances.

In a single move, The coach can:
...
The coach wants to make the lists identical (i.e., $a_i = b_i$ for all $1 \le i \le n$) using the **minimum** number of moves.

Determine the minimum number of moves required to achieve this goal.
