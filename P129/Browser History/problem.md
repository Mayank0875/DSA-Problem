...
## Description
A parent checks if a specific sequence of sites was visited.

You are given two strings `target` and `source` consisting of url segments.
...
- Strings consist of url segments.
