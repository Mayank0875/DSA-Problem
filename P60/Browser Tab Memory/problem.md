...
## Description
A browser task manager lists tabs. Even tabs are sorted by memory usage ascending. Odd tabs are sorted by memory usage descending. Given the memory values, order the tabs.
