...
## Description
An engineer has a cargo bay of station modules. They have plans for satellite expansions. An expansion can be built if the cargo bay has the correct modules. Calculate the total module count of all buildable expansions.
