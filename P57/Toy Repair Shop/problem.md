...
## Description
A repairman has a bin of spare toy parts. They have a list of broken toys. A toy can be fixed if the bin has all the missing parts. Calculate the total part count of all fixable toys.
