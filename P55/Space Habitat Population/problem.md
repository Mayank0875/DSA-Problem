...
## Description
A colony consists of several habitats. A strict zoning law states that only habitats with an even population count receive bonus supplies. As shuttles move people in and out (changing habitat populations), calculate the total population of all habitats that currently qualify for the bonus.
