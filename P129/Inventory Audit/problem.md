...
## Description
An auditor checks for a specific sequence of high-value items in a warehouse list.

You are given two strings `target` and `source` consisting of SKU chars.
