...
## Description
A streaming site lists movies. Even slots show movies sorted by user rating ascending. Odd slots show movies sorted by user rating descending. Given the ratings, create the list.
