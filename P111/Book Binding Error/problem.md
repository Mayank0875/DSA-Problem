...
## Description
A printing press error caused the letters on a book's spine to be printed in reverse order.

The data is stored as a string `s`. To fix the title, you must reverse the string.
