...
## Description
A movie database lists user ratings sorted from 1 to 10. A statistician wants to find the first review that gave a specific target score. Given the sorted list of ratings, find the index of the first occurrence of the target rating.
