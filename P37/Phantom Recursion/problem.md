...
In the realm of the Arcane Library, a lone archivist must conjure at least n phantom copies of a forbidden manuscript before the midnight bell tolls. The original manuscript is already in his possession. He has two recursion spells at his disposal. The first spell creates a copy in x seconds, the second in y seconds. Both spells can be cast on the original or any existing copy, and they may be used simultaneously. Determine the minimum amount of time required to have at least n new phantom copies, starting with just the original.
