...
## Description
A knitting guide shows a stitch row `s`. A novice knitter skips stitches by accident. How many unique flawed patterns can be produced from the original guide?
