...
## Description
A mechanic has a box of bolts sorted by length. They need a bolt that is at least a specific length to secure a machine part. Find the index of the first bolt in the sorted box that meets the length requirement.
