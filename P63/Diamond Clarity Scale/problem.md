...
## Description
A jeweler sets $n$ diamonds in a bracelet. There are 5 clarity grades used. The diamonds must be arranged from lowest to highest clarity to create a gradient effect. How many bracelet arrangements are possible?
