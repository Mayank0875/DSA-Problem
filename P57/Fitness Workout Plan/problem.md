...
## Description
A gym has a rack of weights and equipment. They have a list of workout routines. A routine can be performed if the gym has all the equipment. Calculate the total equipment count of all performable routines.
