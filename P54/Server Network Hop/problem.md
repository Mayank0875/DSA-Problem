...
## Description
A data packet travels through a grid of servers. The packet needs to follow a specific routing protocol sequence. It hops between adjacent servers. Check if the required route exists in the server grid.
