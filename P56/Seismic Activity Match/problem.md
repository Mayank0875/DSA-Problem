...
## Description
Geologists compare sensor data from two different earthquake events, recorded as intensity integers. They need to find the longest continuous duration where the seismic waves were identical. Find the length of this shared tremor pattern.
