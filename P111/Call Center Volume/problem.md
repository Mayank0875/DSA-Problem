...
## Description
A center tracks calls per minute. Managers use a smoothed average to staff the lines appropriately.

You are given a **0-indexed** array `nums` of `n` integers representing call volumes and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of call volumes.
