...
## Description
A rare book collector wants to create a custom dust jacket that spans multiple books on a shelf. The books have different heights. The jacket must be rectangular and cannot be taller than the shortest book it covers. Calculate the maximum surface area of the spine that this jacket can cover.
