...
## Description
A machine stamping license plates has the die set loaded incorrectly, printing the alphanumeric code in reverse.

The data is stored as a string `s`. To verify the correct plate number, you must reverse the string.
