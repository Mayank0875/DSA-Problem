...
## Description
A jeweler keeps an inventory of loose diamonds sorted by carat weight. A client is interested in a specific weight for a ring setting. The jeweler needs to quickly count how many diamonds of that exact weight are currently in stock.
