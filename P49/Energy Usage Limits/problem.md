...
## Description
A smart meter records hourly energy usage, and the data is sorted by consumption amount. The utility company wants to flag high-usage hours. Given a usage limit, find the index of the first entry in the sorted logs that exceeds or equals this limit.
