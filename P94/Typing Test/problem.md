...
## Description
You delete characters in a text editor. You can backspace characters equal to any digit in the current word count.

The word count currently has a value of $n$. To clear the document, you must reduce this value exactly to $0$.
