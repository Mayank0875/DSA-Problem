...
## Description
Cryptographers are analyzing two intercepted messages encoded as number sequences. They look for the longest continuous overlapping pattern, which might indicate a reused encryption key or a common phrase. Calculate the length of the longest matching segment.
