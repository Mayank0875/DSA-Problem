...
## Description
A knitter has a stash of yarn skeins. They have patterns for projects. A project can be started if the stash has all the required yarn types. Calculate the total yarn unit count of all startable projects.
