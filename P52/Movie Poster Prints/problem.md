...
## Description
A collector sorts posters by year. Limited prints (fewest copies) are valued highest and listed first. If copy counts are the same, the poster from the later year (higher value) is listed first.
