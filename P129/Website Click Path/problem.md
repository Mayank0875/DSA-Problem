...
## Description
A UX designer analyzes user logs to find how many ways users navigated a specific 'Home -> Shop -> Buy' path.

You are given two strings `target` and `source` consisting of page IDs.
