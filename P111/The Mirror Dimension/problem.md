...
## Description
You are trapped in a mirror world where everything is flipped. To send a distress signal back to the real world, you must type your message in reverse.

The data is stored as a string `s`. To transmit the signal properly, you must reverse the string.
