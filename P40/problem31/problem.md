...
A physicist is studying a series of spectral intensity measurements taken at successive wavelengths. For each measurement, they want to identify the intensity of the nearest future wavelength that exhibits a strictly higher intensity. This helps them track rising energy peaks or detect significant spectral features. If no future measurement has a higher intensity (either because it is the last measurement or all subsequent measurements are lower or equal), this should be noted. Can you calculate this for each wavelength?
