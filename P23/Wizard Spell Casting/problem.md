...
A coven of `n` wizards is casting a barrier spell that requires `t` individual runes to be placed. Each wizard `i` chants at a different speed, taking `k[i]` seconds to cast one rune. All wizards can cast their runes in parallel. What is the minimum time needed for the coven to cast all `t` runes?
