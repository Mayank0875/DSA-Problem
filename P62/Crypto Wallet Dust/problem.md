...
## Description
A trader consolidates k small transactions (dust). Transactions are by coin ID. They wipe out the small balances first. Calculate the minimum number of unique coins remaining in the wallet.
