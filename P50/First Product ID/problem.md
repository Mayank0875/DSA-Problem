...
## Description
An e-commerce platform lists product IDs in a catalog sorted numerically. A support agent needs to find the system index of the first product matching a specific ID to update its details. Given the sorted list of IDs, return the index of the first occurrence of the target ID.
