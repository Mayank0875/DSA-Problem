...
## Description
A city electric scooter service allows tandem riding (max 2 people) if the total weight is within the scooter's motor limit. Given the weights of a group of friends wanting to travel together, find the minimum number of scooters they need to rent.
