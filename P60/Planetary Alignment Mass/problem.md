...
## Description
A simulation aligns planets. Even orbital slots are filled by planets sorted by mass ascending. Odd orbital slots are filled by planets sorted by mass descending. Given the planetary masses, determine the orbital arrangement.
