...
## Description
A tech company tests the battery life of thousands of units. The results (in minutes) are sorted. Quality control needs to report the number of units that lasted exactly a specific duration.
