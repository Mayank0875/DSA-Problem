...
## Description
A puzzle has `n` pieces with specific edge complexities. A complex section is formed by pieces whose edge complexities share no common factor (GCD is 1).

Your task:
Count how many non-empty subsequences of pieces have a greatest common divisor (GCD) of their complexitys exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the complexitys.
