...
## Description
A tracker estimates calories burned per minute. A smoothed average gives the user a better idea of their workout intensity.

You are given a **0-indexed** array `nums` of `n` integers representing calorie counts and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of calorie counts.
