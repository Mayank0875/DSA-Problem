...
## Description
A shipping manifest lists the weight of containers. A crane safety system only aggregates weights from 'balanced' containers (those with an even weight). As cargo is added or removed from specific containers, modifying their weight, you must report the total weight of all balanced containers currently on the dock.
