...
## Description
A cleaner checks a wall for a gang tag hidden among other scribbles.

You are given two strings `target` and `source` consisting of paint colors.
...
- Strings consist of paint colors.
