...
## Description
A text editor implements 'Undo' by keeping a history string. To revert to the start, the history of actions needs to be traversed backwards.

The data is stored as a string `s`. To implement the undo logic, you must reverse the string.
