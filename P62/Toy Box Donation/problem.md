...
## Description
A child donates k toys to charity. Toys are categorized by type ID. The parent encourages getting rid of clutter by removing entire types of toys (like all the broken cars). Calculate the minimum number of unique toy types remaining.
