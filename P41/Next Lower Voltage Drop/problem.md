...
## Description
You are an electrical engineer monitoring a power line. You have a log of voltage readings taken every second. To analyze stability, you need to find the voltage of the nearest future second that is strictly lower than the current reading. This helps identify downward fluctuations immediately following a measurement. Given the stream of voltage data, determine the next lower voltage value for each reading. If subsequent readings are all equal or higher, indicate that no drop occurs.
