...
## Description
A desert profile consists of sand dunes of different heights. Rare rainstorms create temporary oases in the valleys between dunes. Given the height of the dunes in a line, calculate the total volume of water that the desert terrain can hold.
