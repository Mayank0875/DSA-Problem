...
## Description
A lake survey records depth measurements sorted by depth. A hydrologist wants to find the first location index with a specific depth. Given the sorted list of depth values, return the index of the first occurrence of the target depth.
