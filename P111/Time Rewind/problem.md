...
## Description
You possess a chronometer that records events. To undo a mistake, you must reverse the sequence of event codes stored in the device's memory.

The data is stored as a string `s`. To rewind time, you must reverse the string.
