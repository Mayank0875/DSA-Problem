...
## Description
A game database lists the level requirements for various items, sorted by level. A player wants to find the first item that requires exactly a specific level. Given the sorted list of level requirements, return the index of the first occurrence of the target level.
