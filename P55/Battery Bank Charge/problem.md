...
## Description
A solar farm charges a bank of batteries. Batteries with an even charge percentage are connected to the main grid. As energy is stored or drained, calculate the total charge percentage available to the main grid from these specific batteries.
