...
## Description
An officer destroys k pieces of old evidence. Evidence is by case ID. They clear out the small, closed cases first. Determine the minimum number of unique cases represented in the locker.
