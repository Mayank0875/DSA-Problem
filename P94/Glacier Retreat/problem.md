...
## Description
A glacier recedes. It loses meters of length equal to any digit in its current length measurement.

The glacier length currently has a value of $n$. To measure total melt, you must reduce this value exactly to $0$.
