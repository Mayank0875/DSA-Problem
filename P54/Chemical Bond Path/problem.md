...
## Description
A chemist is analyzing a molecular lattice structure grid. They want to know if a specific polymer chain (represented by a string of element symbols) can be formed within this lattice by connecting adjacent atoms. Determine if the chain exists.
