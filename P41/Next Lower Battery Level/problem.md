...
## Description
You are debugging a battery drain issue where the percentage sometimes fluctuates upwards due to calibration errors. For each recorded battery percentage, you want to find the nearest future reading that is strictly lower. This confirms when the battery actually resumes draining. Given the list of percentage readings, find the next lower value for each. If the reading stays constant or rises for the rest of the log, output -1.
