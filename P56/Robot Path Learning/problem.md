...
## Description
Two robots navigate a maze and log their moves (direction codes). An AI researcher compares the logs to find the longest continuous path segment where both robots made the exact same moves. Calculate the length of this path.
