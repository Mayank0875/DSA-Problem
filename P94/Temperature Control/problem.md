...
## Description
A reactor core is overheating. The cooling system reduces the temperature by degrees equal to any digit in the current temperature reading.

The core temperature currently has a value of $n$. To stabilize the reactor, you must reduce this value exactly to $0$.
