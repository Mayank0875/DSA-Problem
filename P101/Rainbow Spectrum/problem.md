...
## Description
A prism splits light into `s`. Filters block specific bands. How many unique spectra can be projected?

Your task is to determine the total number of distinct non-empty spectra that can be formed. Two spectra are considered distinct if they are not identical strings. As the number of possibilities can be substantial, print the answer modulo $10^9 + 7$.
