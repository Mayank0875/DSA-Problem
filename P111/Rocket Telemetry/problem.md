...
## Description
A rocket sends altitude data. Ground control smooths the data to track the trajectory accurately despite sensor noise.

You are given a **0-indexed** array `nums` of `n` integers representing altitude readings and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of altitude readings.
