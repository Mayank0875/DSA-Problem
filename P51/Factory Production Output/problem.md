...
## Description
A factory supervisor records the number of widgets produced daily. To analyze productivity surges, they calculate a streak for each day: the number of consecutive days leading up to today (inclusive) where the output was less than or equal to today's output. Given the production logs, calculate this streak for each day.
