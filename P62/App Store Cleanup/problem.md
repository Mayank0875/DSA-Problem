...
## Description
A developer has installed many apps categorized by ID. To save memory, they delete exactly k apps. They prefer to delete apps such that entire categories disappear from their phone. What is the minimum number of app categories left?
