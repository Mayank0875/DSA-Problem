...
## Description
An archaeologist counts potential meanings by forming words from a wall of symbols.

You are given two strings `target` and `source` consisting of symbols.
