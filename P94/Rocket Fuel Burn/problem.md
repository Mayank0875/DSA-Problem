...
## Description
A rocket burns fuel. The burn rate consumes gallons equal to any digit in the current fuel reserve.

The fuel reserve currently has a value of $n$. To deplete the fuel, you must reduce this value exactly to $0$.
