...
## Description
A warehouse stacks boxes. Stacks with an even height are considered stable. As boxes are added or removed from stacks, calculate the total height of all stable stacks.
