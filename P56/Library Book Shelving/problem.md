...
## Description
A librarian compares the order of books on two shelves (ISBNs). They want to find the longest continuous block of books that are arranged identically on both shelves. Find the number of books in this block.
