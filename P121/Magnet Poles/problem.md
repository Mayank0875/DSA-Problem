...
## Description
Physics students study magnets. Each magnet ID must represent two poles (N and S).

The lab bench has a list of poles, represented by their IDs. For the physics experiment, every type of pole in the list must appear **exactly twice**.

You can perform two types of operations:
1. **Add**: Add a new pole of an existing ID (cost: 1).
2. **Remove**: Remove an existing pole from the list (cost: 1).
