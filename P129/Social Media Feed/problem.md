...
## Description
An algorithm counts how many times a user sees a sequence of related ads.

You are given two strings `target` and `source` consisting of ad types.
