...
## Description
Two dance routines are recorded as sequences of move IDs. A choreographer wants to identify the longest continuous sequence of moves that is the same in both routines. Find the number of moves in this shared sequence.
