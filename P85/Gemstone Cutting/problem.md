...
## Description
A jeweler has `n` rough gems of different carat weights. A custom jewelry set is made from gems whose weights (in points) have a GCD of 1.

Your task:
Count how many non-empty subsequences of gems have a greatest common divisor (GCD) of their weights exactly equal to 1.
