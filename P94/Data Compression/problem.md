...
## Description
A file is being compressed. The algorithm reduces file size by bytes equal to any digit in the current size.

The file size currently has a value of $n$. To compress the file, you must reduce this value exactly to $0$.
