...
## Description
An astronaut moves through a grid of modules in a space station. To repressurize, they must pass through a specific sequence of module types. They move through adjacent airlocks. Verify if the repressurization route is valid.
