...
## Description
An apple chute changes angle. Apples roll down, hitting gates.
...
Changing the angle causes the entire grid to **rotate 90 degrees clockwise**. Following this rotation, gravity takes effect, causing the apples to fall downwards. Each apple falls until it lands on a gate, another apple, or the bottom boundary of the grid.

**Crucial Rules:**
1.  Gravity does not affect gates; they are anchored in place relative to the grid structure.
...
#### Explanation
The gates hold their relative positions. apples pile up on top of obstacles or the floor.
