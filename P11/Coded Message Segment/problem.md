...
A spy receives a binary message of length N. '1' represents a valid signal bit, while '0' represents corrupt noise. A "decipherable segment" is a contiguous part of the message that contains at most `k` noise bits. Find the length of the longest decipherable segment in the message.
