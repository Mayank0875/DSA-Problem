...
## Description
Luxury handbags often increase in value. A fashionista wants to buy a bag and sell it later. Given the monthly resale value, calculate the maximum profit.
