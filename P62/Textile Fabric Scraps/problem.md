...
## Description
A quilter uses k fabric scraps. Scraps are by pattern ID. They use up the odd bits first to declutter. Calculate the minimum number of unique patterns left.
