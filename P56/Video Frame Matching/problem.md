...
## Description
An editor has two video clips and suspects one is a cut of the other. The videos are represented by sequences of frame checksums. Find the longest continuous sequence of frames that is identical in both videos to determine the length of the reused footage.
