...
## Description
An engine spins down. The governor reduces RPM by an amount matching any digit in the current tachometer reading.

The RPM currently has a value of $n$. To stop the engine, you must reduce this value exactly to $0$.
