...
## Description
A wind farm has `n` turbines with different blade lengths. To reduce aerodynamic wake interference, active turbines should have blade lengths with a GCD of 1.

Your task:
Count how many non-empty subsequences of turbines have a greatest common divisor (GCD) of their blade lengths exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the blade lengths.
