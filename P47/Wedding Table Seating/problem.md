...
## Description
A wedding planner is arranging seating for a reception using small bistro tables. Each table seats at most two guests and has a 'social energy' limit (represented by an integer value). Given the energy levels of the guests, find the minimum number of tables needed.
