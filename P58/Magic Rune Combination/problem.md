...
## Description
A wizard has a bag of runes, each inscribed with a power level. To cast a specific spell, two runes must be drawn whose combined power equals the spell's requirement. Calculate the number of ways the wizard can pick two runes to cast the spell successfully.
