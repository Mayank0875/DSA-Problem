...
## Description
A mint produces coins with specific batch numbers. Some batches are rarer due to errors. Sort the coins so that the batch numbers appearing least frequently come first. If batches have the same frequency, prioritize the higher batch number.
