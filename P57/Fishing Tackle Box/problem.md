...
## Description
A fisherman has a box of lures and hooks. They have a guide for catching specific fish. A fish can be targeted if the box has the specific tackle. Calculate the total tackle count of all targetable fish.
