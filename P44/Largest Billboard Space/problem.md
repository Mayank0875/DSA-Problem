...
## Description
You are an advertiser looking to place a huge rectangular billboard on a series of adjacent buildings. The buildings have different heights but the same width. You can place the billboard across multiple buildings, but its height is limited by the shortest building in that range. Given the heights of the buildings, determine the maximum area of the billboard you can install.
