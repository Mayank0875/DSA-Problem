...
## Description
A mason lays bricks. A wall section is 'stable' if the total weight equals the missing brick size.

Bob is analyzing a sequence of n bricks. Each brick has a specific weight (a non-negative integer).

A contiguous group of bricks is considered **stable** if the sum of their weight values is exactly equal to the **Missing Size** of that group.
