...
## Description
A jeweler sorts gems by hardness scale. Rare gems (fewest available) are processed first. If counts are tied, the harder gem (higher value) is processed first.
