...
## Description
A family has a box of ornaments. They have ideas for tree themes. A theme can be decorated if the box has all the ornaments. Calculate the total ornament count of all decorate-able themes.
