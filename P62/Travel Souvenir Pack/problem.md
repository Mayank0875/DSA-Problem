...
## Description
A tourist mails home k souvenirs. Souvenirs are by type ID. They mail the random odds and ends first. Find the minimum number of unique souvenir types left in their suitcase.
