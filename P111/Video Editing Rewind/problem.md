...
## Description
A film editor wants to create a 'rewind' effect. The frames of the clip (represented as characters) need to be played last-to-first.

The data is stored as a string `s`. To create the rewind effect, you must reverse the string.
