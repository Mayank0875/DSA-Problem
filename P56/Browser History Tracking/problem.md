...
## Description
An analytics tool compares the browsing history of two sessions, represented by page IDs visited in order. Find the longest continuous path of pages visited in both sessions to understand common user flows. Return the path length.
