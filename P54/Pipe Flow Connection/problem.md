...
## Description
A plumbing schematic shows a grid of pipe types. A plumber needs to trace a specific flow route defined by a sequence of pipe codes. The flow moves to adjacent grid sections. Determine if the route is valid.
