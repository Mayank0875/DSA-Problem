...
## Description
A simulation of a tidal wave shows it advancing. To simulate the water receding, the flow vectors in the model string need to be reversed.

The data is stored as a string `s`. To simulate the receding tide, you must reverse the string.
