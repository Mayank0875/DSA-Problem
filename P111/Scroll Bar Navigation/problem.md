...
## Description
A user scrolls down a webpage. Clicking 'Back to Top' effectively reverses the scroll coordinate history.

The data is stored as a string `s`. To return to the top, you must reverse the string.
