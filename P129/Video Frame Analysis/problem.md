...
## Description
AI detects a specific sequence of actions (e.g., 'Run', 'Jump') from a video metadata stream.

You are given two strings `target` and `source` consisting of action codes.
...
- Strings consist of action codes.
