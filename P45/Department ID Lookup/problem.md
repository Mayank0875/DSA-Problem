...
## Description
A large corporation lists all active access key swipes by Department ID, sorted for the daily report. Security wants to know how many times a specific Department ID appears in the logs.
