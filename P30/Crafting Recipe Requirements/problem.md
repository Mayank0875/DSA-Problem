...
In a video game, you are crafting a legendary item that requires a total "essence" of $T$. You have a collection of materials, each providing a different amount of essence (e.g., 2, 3, 5). Your task is to find the *total number* of unique combinations of these materials that provide exactly $T$ essence. You have an infinite supply of each material.
