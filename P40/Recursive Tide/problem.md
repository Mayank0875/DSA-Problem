...
A coastal research team is analyzing a sequence of recorded tide heights to understand the water level dynamics. For each recorded tide, they want to identify the height of the nearest future tide that is strictly higher. This information helps them predict rising water trends and detect significant surges. If no future tide is higher (either because it is the last measurement or all subsequent tides are lower or equal), this should be indicated. Can you compute this for each tide measurement?
