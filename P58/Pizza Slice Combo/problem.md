...
## Description
A pizzeria sells slices with different calorie counts. A customer wants a meal consisting of exactly two slices that sums to a precise calorie limit. Given the calorie counts of available slices, count the number of meal combinations the customer can choose.
