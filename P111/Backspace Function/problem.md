...
## Description
You are implementing a text editor. Selecting a sentence and hitting 'Reverse' flips the characters for a stylistic effect.

The data is stored as a string `s`. To apply the style, you must reverse the string.
