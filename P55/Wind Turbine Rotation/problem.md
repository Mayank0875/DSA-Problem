...
## Description
A wind farm monitors turbine RPM. Turbines spinning at an even RPM are synchronized to the grid. As wind speeds change the RPMs, calculate the sum of RPMs of all synchronized turbines.
