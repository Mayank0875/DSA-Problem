...
## Description
An auction timer counts down. The auctioneer can skip seconds equal to any digit in the remaining time.

The time remaining currently has a value of $n$. To close the auction, you must reduce this value exactly to $0$.
