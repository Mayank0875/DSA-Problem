...
A game character needs to gain exactly $T$ experience points (XP) to level up. The character can complete different types of quests, each rewarding a certain amount of XP (e.g., 2, 3, 5). Any quest can be repeated. Your task is to find the *total number* of unique combinations of quests that will grant exactly $T$ XP.
