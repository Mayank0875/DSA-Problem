...
## Description
Sensors in a field measure wetness. An irrigation system uses the average moisture level to decide when to water.

You are given a **0-indexed** array `nums` of `n` integers representing moisture levels and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of moisture levels.
