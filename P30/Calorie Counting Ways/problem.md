...
You are on a diet and want to prepare a meal with exactly $T$ calories. You have a list of food items, each with a specific calorie count (e.g., 2, 3, 5). You can use an unlimited amount of each food item. How many *total unique combinations* of these foods can you use to reach exactly $T$ calories?
