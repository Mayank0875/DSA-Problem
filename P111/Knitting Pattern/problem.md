...
## Description
To knit the reverse side of a scarf, the pattern instructions from the front side must be followed backwards.

The data is stored as a string `s`. To generate the reverse pattern, you must reverse the string.
