...
## Description
Architects compare two versions of a building plan, represented as layers of material codes. They want to find the longest continuous stack of layers that is identical. Determine the height (number of layers) of this matching stack.
