...
## Description
A digital TV has a list of active channel frequencies sorted numerically. The user enters a channel number directly. If that specific channel doesn't exist, the TV should tune to the next available channel with a higher or equal number. Find the index of this channel in the list.
