...
## Description
A signal processor reads voltage levels on multiple channels. Channels with even voltage are considered 'parity synced'. As noise adds or subtracts voltage from specific channels, you must calculate the sum of voltages from all currently synced channels after each change.
