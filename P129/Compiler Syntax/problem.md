...
## Description
A compiler checks for valid nested loop structures in a stream of tokens.

You are given two strings `target` and `source` consisting of tokens.
