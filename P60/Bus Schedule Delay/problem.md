...
## Description
A transit authority analyzes delays. Even route numbers are sorted by average delay ascending. Odd route numbers are sorted by average delay descending. Given the delay times, reorder the schedule.
