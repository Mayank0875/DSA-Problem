...
## Description
A reservoir drains through smart sluices. The sluices release water gallons equal to any digit in the current water level.

The water level currently has a value of $n$. To drain the tank, you must reduce this value exactly to $0$.
