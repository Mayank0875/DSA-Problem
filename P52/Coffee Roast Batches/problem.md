...
## Description
A roastery sorts batches by intensity. Rare experimental batches (low quantity) are tasted first. If quantities match, the higher intensity batch is tasted first.
