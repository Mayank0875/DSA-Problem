...
## Description
A digital library sorts its collection based on the number of pages in each book. A reader is looking for books of a very specific length. You must calculate how many books in the library have exactly that number of pages.
