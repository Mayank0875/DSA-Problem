...
## Description
A witch has a cauldron and a shelf of ingredients. She has a grimoire of spells. A spell can be cast if the shelf has all the ingredients. Calculate the total potency (length) of all castable spells.
