...
## Description
A DNA sequencer reads a strand. Valid bases are integers, and read errors are `0`. The software needs to justify the valid sequence to the left, pushing all error placeholders to the right end of the data array.
