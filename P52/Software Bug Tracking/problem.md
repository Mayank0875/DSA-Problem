...
## Description
A QA team logs bug IDs. They want to focus on unique, non-recurring bugs first. Sort the bug log so that IDs appearing the fewest times are at the top. If bugs appear with the same frequency, list the higher ID first.
