...
## Description
Tarzan wants to swing through the jungle. The canopy is a grid of trees. He needs to swing across a specific sequence of tree species. He can only swing to adjacent trees. Check if his path is possible.
