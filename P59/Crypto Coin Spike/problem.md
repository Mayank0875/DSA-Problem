...
## Description
A digital currency trader watches the minute-by-minute value of 'StarCoin'. They want to execute exactly one buy order and one sell order later to capitalize on a price spike. Given the price stream, calculate the maximum gain.
