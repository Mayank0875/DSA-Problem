...
## Description
A fleet of devices reports battery levels, which are listed in sorted order. A maintenance crew needs to find the first device with a specific battery percentage. Given the sorted battery levels, return the index of the first occurrence of the target level.
