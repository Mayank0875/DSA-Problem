...
## Description
A DJ organizes songs. Songs with an even duration (in seconds) fit a specific beat mixing technique. As the DJ edits tracks (changing their length), calculate the total duration of all songs compatible with the mixing technique.
