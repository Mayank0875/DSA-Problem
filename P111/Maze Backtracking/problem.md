...
## Description
A solver robot has reached a dead end. It must execute its move history in reverse to return to the last junction.

The data is stored as a string `s`. To backtrack successfully, you must reverse the string.
