...
## Description
A fuel line contains fuel pellets (non-zero) and gas bubbles (`0`). The injector system uses a centrifuge to force the heavier fuel pellets to the nozzle (front), pushing the gas bubbles to the back bleed valve.
