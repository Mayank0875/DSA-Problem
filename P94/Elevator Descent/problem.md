...
## Description
A turbo elevator goes down. It can skip floors equal to any digit in the current floor number.

The floor number currently has a value of $n$. To reach the ground floor, you must reduce this value exactly to $0$.
