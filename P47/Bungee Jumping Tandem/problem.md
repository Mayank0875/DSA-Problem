...
## Description
A bungee jumping site allows tandem jumps (2 people together). The bungee cord has a maximum weight rating. Given the weights of the jumpers, calculate the minimum number of jumps required so that everyone gets to jump.
