...
## Description
A weather station records hourly rainfall. Hydrologists use a centered average to model flood risks from sustained precipitation.

You are given a **0-indexed** array `nums` of `n` integers representing rainfall amounts and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of rainfall amounts.
