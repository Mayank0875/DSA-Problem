...
## Description
A storm simulation grid records charge potentials. A lightning bolt follows a path of specific potential values. It jumps between adjacent cells. Check if a discharge path matching the specific sequence occurred.
