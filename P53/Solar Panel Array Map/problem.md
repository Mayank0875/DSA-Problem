...
## Description
A control system monitors a row of solar panels. Generating panels return positive voltage, while broken ones return `0`. The system re-maps the logic addresses to group all generating panels at the start of the address space, pushing broken ones to the end.
