...
## Description
An election commission tracks votes in districts. Districts with an even vote count trigger an automatic recount. As new ballots are counted, report the total votes in all districts currently triggered for a recount.
