...
## Description
A water park slide uses inflatable rafts. Each raft seats two people max. For safety, the total weight in a raft cannot exceed a specified limit. Given the weights of the riders, find the minimum number of rafts needed.
