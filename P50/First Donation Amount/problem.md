...
## Description
A charity records donation amounts sorted by value. A fundraiser wants to find the first donor who gave exactly a specific target amount. Given the sorted list of donations, find the index of the first occurrence of the target amount.
