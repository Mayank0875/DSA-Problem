...
## Description
A player has `n` cards with power ratings. A winning hand is defined as a set of cards where the GCD of their power ratings is 1.

Your task:
Count how many non-empty subsequences of cards have a greatest common divisor (GCD) of their power ratings exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the power ratings.
