...
Next Higher Chamber in the Parallel Labyrinth

## Slug

next-higher-chamber-parallel-labyrinth
...
Adventurers are exploring a vast Parallel Labyrinth where each chamber has a difficulty rating. For every chamber they enter, they want to know the difficulty of the nearest future chamber (further along their predetermined path) that has a strictly higher difficulty. This information helps them gauge the increasing challenges ahead or spot particularly tough sections. If there is no later chamber with a higher difficulty (either because it is the last chamber or all subsequent chambers are easier or equally difficult), this should be indicated. Can you determine this for each chamber?
