...
## Description
A monitor logs the status of $n$ servers. There are 5 load states (Idle, Low, Medium, High, Critical). The log is sorted by load state. How many status reports are possible?
