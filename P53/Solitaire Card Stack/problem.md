...
## Description
A stack of cards in a digital game has face-up cards (values) and empty placeholders (`0`). The game engine renders the stack by drawing all face-up cards at the bottom (array start), pushing placeholders to the top (array end).
