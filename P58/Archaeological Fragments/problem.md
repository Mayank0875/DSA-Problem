...
## Description
Archaeologists have found broken pottery shards. Two shards form a complete pot if their arc lengths sum up to 360 degrees (or a specific target size). Given the sizes of the shards, count the number of pairs that could potentially form a whole pot.
