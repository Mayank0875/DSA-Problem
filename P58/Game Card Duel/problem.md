...
## Description
In a trading card game, a player can summon a creature by sacrificing two cards. The sum of the mana costs of the two cards must exactly equal the creature's summoning cost. Given the mana costs of the cards in hand, count the number of pairs that can be used to summon the creature.
