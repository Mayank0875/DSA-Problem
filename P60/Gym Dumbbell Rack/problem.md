...
## Description
A gym organizes dumbbells on a long rack. Even pegs should hold weights sorted light-to-heavy. Odd pegs should hold weights sorted heavy-to-light. Given the weights of the dumbbells, show how they should be racked.
