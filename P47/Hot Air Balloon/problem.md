...
## Description
A hot air balloon festival offers rides. The baskets are partitioned into small compartments that hold at most two people, with a weight limit per compartment. Given the weights of the passengers, determine the minimum number of compartments (or balloons) required.
