...
## Description
A typing algorithm compares what a user typed vs. a dictionary phrase, converted to character codes. It finds the longest continuous substring that matches to suggest completions. Calculate the length of the longest matching character sequence.
