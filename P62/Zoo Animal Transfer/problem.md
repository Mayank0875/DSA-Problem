...
## Description
A zoo is overcrowding and must transfer exactly k animals to another sanctuary. The animals are listed by species ID. To streamline care, the zookeeper wants to reduce the diversity of species left in the enclosure. Calculate the minimum number of unique species remaining after the transfer.
