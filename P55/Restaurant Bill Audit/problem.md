...
## Description
A restaurant auditor checks open tabs. Tabs with an even dollar amount are eligible for a lottery. As items are ordered or removed from tabs, calculate the total value of all tabs currently eligible for the lottery.
