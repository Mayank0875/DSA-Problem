...
## Description
A numismatist sorts coins by denomination. Rare denominations in the collection should be valued first. If the count of two denominations is the same, the higher denomination is placed first.
