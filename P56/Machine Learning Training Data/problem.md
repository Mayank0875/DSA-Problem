...
## Description
A data scientist compares two datasets of integer features. They want to find the longest continuous sub-sequence of data points that is identical in both sets to detect data leakage. Calculate the length of this duplicate segment.
