...
## Description
A predictive text algorithm calculates the probability of a word being typed based on the subsequence of keys pressed.

You are given two strings `target` and `source` consisting of lowercase English letters.
