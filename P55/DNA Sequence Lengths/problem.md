...
## Description
Geneticists analyze DNA fragments. Fragments with an even base-pair length are suitable for a specific cloning process. As fragments are spliced or trimmed, calculate the total length of all clone-ready fragments.
