...
## Description
A textile loom weaves threads in a grid. A quality check looks for a specific defect pattern (sequence of thread types). The defect would be continuous along adjacent threads. Determine if the defect pattern exists.
