...
## Description
Sonar readings of a riverbed are erratic. Hydrologists smooth the depth profile by averaging adjacent readings to find the true navigable depth.

You are given a **0-indexed** array `nums` of `n` integers representing depth readings and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of depth readings.
