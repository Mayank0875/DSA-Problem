...
## Description
Antivirus software cleans a system. It removes infected files equal to any digit in the current infection count.

The infection count currently has a value of $n$. To clean the system, you must reduce this value exactly to $0$.
