...
## Description
A microscopic view of a fabric weave shows threads at different heights. When dyed, the liquid collects in the microscopic gaps between threads. To estimate dye usage, calculate the total volume of liquid trapped in the weave profile given the thread heights.
