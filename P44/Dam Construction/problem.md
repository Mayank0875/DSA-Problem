...
## Description
Engineers are surveying a riverbed profile to build a rectangular concrete dam. The riverbed depth varies at different points across the width. We can model the available depth profile as a histogram. The dam wall must be rectangular. Find the maximum area of the dam wall that can be constructed within the bounds of the measured depths.
