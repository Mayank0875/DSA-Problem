...
## Description
A dreamer recalls a sequence of images `s`. Waking up erases memories. How many unique dreams could the dreamer remember?

Your task is to determine the total number of distinct non-empty dreams that can be formed. Two dreams are considered distinct if they are not identical strings. As the number of possibilities can be substantial, print the answer modulo $10^9 + 7$.
