...
## Description
Two musicians are playing different songs, but they believe a specific melody was stolen. The songs are represented as arrays of note pitches. You need to find the longest continuous sequence of notes that is exactly the same in both songs to identify the copied melody.
