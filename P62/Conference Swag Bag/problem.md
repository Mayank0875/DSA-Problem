...
## Description
An attendee gives away k items from their swag bag. Items are by type ID. They give away the random singular items first. Find the minimum number of unique item types kept.
