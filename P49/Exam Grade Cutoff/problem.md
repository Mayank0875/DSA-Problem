...
## Description
A teacher has a sorted list of student scores. To determine grade boundaries, they want to find the position of the first student who scored at least a specific qualifying mark. Finding this index allows the teacher to calculate how many students passed. Given the sorted scores and the passing mark, return the index of the first qualifying score.
