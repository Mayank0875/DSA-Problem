...
In a game, you need to gather exactly $T$ units of wood. You can chop down different types of trees, which yield different amounts of wood (e.g., 2, 3, 5 units). You can chop an unlimited number of each tree type. How many *total unique combinations* of trees can you chop to get exactly $T$ units of wood?
