...
An astronomer is scanning deep space. She detects energy signatures with values from L to R. She theorizes that signatures with a perfect square value indicate an advanced civilization. How many such signatures are in the range?
