...
## Description
A commuter checks how many valid itineraries visit a specific sequence of cities from a master schedule.

You are given two strings `target` and `source` consisting of city codes.
