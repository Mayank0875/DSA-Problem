...
Imagine you are analyzing a line of static electric fields placed sequentially, each with a certain intensity. As you examine each field from left to right, you want to know the intensity of the nearest previous field that is strictly stronger than the current one. If all earlier fields are weaker or have equal intensity, or if you are at the first field, there is no such stronger field to the left. Your task is to determine this stronger field's intensity for every position in the line.
