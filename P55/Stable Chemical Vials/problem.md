...
## Description
A chemist tracks the volume of liquid in several vials. Vials with an even number of milliliters are considered chemically stable. You perform a series of experiments that add or subtract liquid from specific vials. After each step, calculate the total volume of liquid held in all stable vials.
