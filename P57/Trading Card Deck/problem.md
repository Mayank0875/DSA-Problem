...
## Description
A player has a collection of spare cards. They have a list of 'meta' decks they want to build. A deck can be built if the collection has all the specific cards. Calculate the total card count of all buildable decks.
