...
A horticulturist is designing a binary bloom garden! They have **n** identical rectangular flower beds that need to be placed in the garden.
Each bed is **w** units wide and **h** units long. To create the garden, they must arrange all beds flat inside a single square plot.
The beds cannot be rotated. Your task is to help the horticulturist find the side length of the smallest possible square plot that can hold all **n** beds without any overlap.
