...
## Description
A manager checks for a sequence of 'Complaint -> Hold -> Refund' in call tags.

You are given two strings `target` and `source` consisting of call tags.
