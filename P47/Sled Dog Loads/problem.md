...
## Description
In the arctic, sleds are used to transport supplies. Each sled is pulled by dogs and can carry at most two supply crates, subject to a weight limit. Given the weights of the crates, determine the minimum number of sleds needed for the expedition.
