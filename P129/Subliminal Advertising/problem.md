...
## Description
A regulator checks how many times the word 'BUY' is hidden as a subsequence in a flashing video frame text.

You are given two strings `target` and `source` consisting of uppercase English letters.
