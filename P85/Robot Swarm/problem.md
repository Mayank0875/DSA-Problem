...
## Description
A swarm of `n` robots has unique serial numbers. A task force performs best if the robots' serial numbers have a GCD of 1.

Your task:
Count how many non-empty subsequences of robots have a greatest common divisor (GCD) of their serial numbers exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the serial numbers.
