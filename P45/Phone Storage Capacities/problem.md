...
## Description
A retailer keeps a record of sold smartphones sorted by storage capacity (e.g., 64, 128, 256 GB). An analyst wants to count the sales volume for a specific storage configuration.
