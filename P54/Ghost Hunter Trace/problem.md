...
## Description
A paranormal investigator scans a room grid for cold spots. They track a ghost's movement as a sequence of temperature readings. The ghost moves between adjacent spots. Determine if the readings form a valid path.
