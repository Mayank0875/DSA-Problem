...
## Description
A jeweler melts down k pieces of jewelry to reuse the gold. Pieces are identified by design ID. They want to discontinue certain designs. Calculate the minimum number of unique designs remaining in the collection.
