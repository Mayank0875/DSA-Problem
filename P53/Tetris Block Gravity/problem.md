...
## Description
In a row of a puzzle game, blocks have colors (non-zero) and empty air is `0`. A gravity shift pulls all blocks to the left side of the screen, pushing the air pockets to the right.
