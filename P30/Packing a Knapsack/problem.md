...
You are packing a knapsack for a hike and want it to weigh exactly $T$. You have several types of items, each with a specific weight (e.g., 2, 3, 5). You have an infinite supply of each item. How many *total unique combinations* of items can you pack to reach the exact target weight $T$?
