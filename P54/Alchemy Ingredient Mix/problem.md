...
## Description
Ingredients are laid out on a prep table grid. An alchemist must mix them in a specific order by grabbing adjacent items. Determine if the required potion recipe can be mixed from the current table setup.
