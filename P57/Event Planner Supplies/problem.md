...
## Description
A planner has a warehouse of decorations. They have a list of party themes. A theme can be executed if the warehouse has all the specific decorations. Calculate the total item count of all executable themes.
