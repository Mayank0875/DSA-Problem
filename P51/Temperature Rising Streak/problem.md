...
## Description
You are analyzing historical weather data. For each day, you want to calculate the 'warming streak'. The streak for a specific day is defined as the number of consecutive days leading up to and including that day where the temperature was less than or equal to the current day's temperature. Given a list of daily temperatures, calculate this streak for every day.
