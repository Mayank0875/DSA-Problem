...
## Description
An internet provider offers plans with different download speeds, listed in increasing order. A customer requires a connection with at least a certain speed for streaming 4K video. The sales system needs to identify the index of the first plan that meets this requirement.
