...
## Description
A weaver has a supply of colored threads. They have patterns for tapestries. A tapestry can be woven if the supply has all the required thread colors. Calculate the total thread units of all weave-able tapestries.
