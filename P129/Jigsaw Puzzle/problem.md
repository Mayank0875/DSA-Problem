...
## Description
A puzzler looks for edge pieces that form a specific border sequence.

You are given two strings `target` and `source` consisting of piece shapes.
...
- Strings consist of piece shapes.
