...
## Description
Air traffic control analyzes the flight paths of two drones, recorded as sequences of altitude checkpoints. They want to find the longest continuous duration where both drones maintained the exact same altitude profile. Find the length of this profile match.
