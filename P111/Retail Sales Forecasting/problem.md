...
## Description
A store tracks daily sales. To predict inventory needs, the manager looks at the smoothed average sales centered on each day.

You are given a **0-indexed** array `nums` of `n` integers representing sales figures and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of sales figures.
