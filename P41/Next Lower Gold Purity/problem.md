...
## Description
A jeweler inspects a sequence of gold bars and measures their purity percentages. For quality control, they want to find the purity of the nearest following bar that is strictly less pure. Given the sequence of purity measurements, find the next lower value for each bar. If all subsequent bars are of equal or higher purity, indicate this.
