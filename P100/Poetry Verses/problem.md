...
## Description
A poet rearranges words in a magnetic poetry line.

The words are represented as a string $S$.
However, the order of the words is not fixed. Each arrangement creates a new line of abstract poetry.

Your task is to calculate the **total number of distinct verses** that can be formed using the characters of the string $S$. Since the number of possibilities can be very large, print the result modulo $10^9 + 7$.
