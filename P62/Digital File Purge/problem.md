...
## Description
A server is running out of space. You need to delete exactly k files. The files are categorized by type IDs. To make the file system cleaner, you aim to remove entire categories of files if possible. Find the minimum number of unique file types left after the deletion.
