...
## Description
A plane needs to dump fuel for an emergency landing. The valves release fuel liters equal to any digit in the current fuel gauge.

The fuel level currently has a value of $n$. To prepare for landing, you must reduce this value exactly to $0$.
