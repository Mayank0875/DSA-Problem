...
## Description
An enemy shield takes damage. Your laser deals damage equal to any digit in the shield's current integrity percentage.

The shield integrity currently has a value of $n$. To destroy the shield, you must reduce this value exactly to $0$.
