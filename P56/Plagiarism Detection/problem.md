...
## Description
A professor is checking two essays for plagiarism. The essays are converted into arrays of word-hash integers. To prove copying, the system looks for the longest continuous sequence of word hashes that appears in both essays. Determine the length of this matching text block.
