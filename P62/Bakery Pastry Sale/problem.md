...
## Description
A baker sells the last k pastries of the day. Pastries are by type ID. They sell out of the low-stock items first. Determine the minimum number of unique pastry types left.
