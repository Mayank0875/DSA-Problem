...
## Description
A ticketing system assigns prices to a row of seats. Even seat numbers get prices sorted low-to-high. Odd seat numbers get prices sorted high-to-low. Given the list of ticket prices, assign them to the seats.
