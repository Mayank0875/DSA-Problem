...
## Description
Climate scientists have daily temperature readings. To study climate rather than weather, they calculate the local average temperature for each day based on a window of surrounding days.

You are given a **0-indexed** array `nums` of `n` integers representing temperatures and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of temperatures.
