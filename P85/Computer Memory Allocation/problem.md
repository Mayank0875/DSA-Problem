...
## Description
An OS manages `n` memory blocks of different sizes. To avoid fragmentation patterns, the kernel groups blocks whose sizes have a GCD of 1.

Your task:
Count how many non-empty subsequences of blocks have a greatest common divisor (GCD) of their sizes exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the sizes.
