...
## Description
A clue on the wall is only readable when viewed through a mirror held in the room.

The data is stored as a string `s`. To decipher the clue, you must reverse the string.
