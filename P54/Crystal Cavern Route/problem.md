...
## Description
A spelunker explores a cavern with crystal formations arranged in a grid. They are looking for a legendary path marked by a specific sequence of crystal colors. They move to adjacent formations. Determine if the path exists.
