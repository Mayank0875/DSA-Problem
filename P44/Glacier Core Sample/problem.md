...
## Description
Scientists are studying a cross-section of a glacier. The ice thickness varies across the section. They want to extract a large rectangular slab of ice for study that is uniform in structure (fitting within the thickness profile). Given the thickness measurements, find the maximum cross-sectional area of the ice slab.
