...
## Description
An engineer is assembling battery packs using two cells. The total voltage of the pair must match the device's required voltage exactly. Given a bin of cells with varying voltages, calculate how many valid pairs can be formed.
