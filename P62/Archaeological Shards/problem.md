...
## Description
A researcher discards k pottery shards that are too small. Shards are by era ID. They discard the eras with few samples. Find the minimum number of unique eras represented in the remaining samples.
