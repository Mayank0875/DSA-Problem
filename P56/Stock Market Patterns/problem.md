...
## Description
A financial algorithm compares the daily price changes of two different stocks over a year. To find correlations, it looks for the longest continuous period where the price change values were identical for both stocks. Calculate the length of this shared trend.
