...
## Description
In a simulation game, you reduce a pest population. You can remove pests equal to any digit in the current population count.

The pest population currently has a value of $n$. To eradicate the pests, you must reduce this value exactly to $0$.
