...
## Description
A competitive eater eats pizza. They can eat slices equal to any digit in the remaining slice count.

The slice count currently has a value of $n$. To finish the pizza, you must reduce this value exactly to $0$.
