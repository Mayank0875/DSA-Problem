...
## Description
A barista blends two beans. Each has an aroma score. The target blend must have a specific total aroma score. Count the number of bean pairs that create the perfect blend.
