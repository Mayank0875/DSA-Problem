...
An ant colony needs to gather `t` pieces of food for the winter. The colony has `n` foraging ants. Each ant `i` is of a different size and can bring back one piece of food, but it takes them `k[i]` seconds for a round trip. All ants can forage in parallel. What is the minimum time the colony needs to gather at least `t` pieces of food?
