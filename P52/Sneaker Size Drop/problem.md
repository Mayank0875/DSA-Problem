...
## Description
A store releases sneakers sorted by size. Rare sizes (lowest inventory) are released online first. If inventory counts are equal, the larger size is released first.
