...
## Description
A crane operator needs to lift steel beams to the top of a building. The crane can hook onto at most two beams at once, and there is a maximum load weight. Given the weights of the beams, calculate the minimum number of lifts required.
