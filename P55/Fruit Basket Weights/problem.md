...
## Description
A market sells fruit baskets. Baskets with an even weight are shipped via a specific courier. As fruit is added or removed from baskets, changing their weights, calculate the total weight of all baskets designated for this courier.
