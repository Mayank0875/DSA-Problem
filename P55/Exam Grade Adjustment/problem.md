...
## Description
A professor curves grades but only uses the sum of even scores as a baseline. As corrections are applied to student exams (adding or losing points), calculate the new baseline sum of all even scores after each correction.
