...
## Description
A traveler is looking at flight durations for two legs of a trip. The total travel time must exactly match their schedule availability. Given a list of possible flight durations, count the number of pairs of flights that fit the schedule perfectly.
