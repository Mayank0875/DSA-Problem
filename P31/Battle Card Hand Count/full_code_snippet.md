...
int main() {
    ...
    while (t--) {
        ...
        int res = countUniqueCombinations(arr, tar);
        cout << res << endl;
...
int main() {
    ...
    while (t--) {
        ...
        int res = countUniqueCombinations(arr, n, tar);
        printf("%d\n", res);
        // evaluation completed
    }
    return 0;
...
function main() {
    ...
    for (let tc = 0; tc < t; tc++) {
        ...
        const res = countUniqueCombinations(arr, tar);
        console.log(res);
        // evaluation completed
    }
}
...
def main():
    ...
    for _ in range(t):
        ...
        res = countUniqueCombinations(arr, tar)
        print(res)
        # evaluation completed
