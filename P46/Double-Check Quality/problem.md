...
## Description
A factory quality assurance line scans product IDs. High-value items must be scanned exactly twice (entry and exit of the testing chamber). Items scanned once were missed; items scanned more often were re-tested. Identify the product IDs that passed the standard double-check procedure correctly.
