...
## Description
A biology paper lists $n$ organisms. They belong to one of 5 kingdoms. The list is ordered according to a specific evolutionary tree (non-decreasing). How many list varieties are there?
