...
## Description
A teacher analyzes test scores arranged by student ID. To see general performance trends, they calculate a local average of scores.

You are given a **0-indexed** array `nums` of `n` integers representing test scores and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of test scores.
