...
## Description
A shipping manifest lists package weights sorted from lightest to heaviest. A packer needs to find the first package that weighs exactly a specific amount. Given the sorted weights, find the index of the first occurrence of the target weight.
