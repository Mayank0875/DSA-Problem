...
## Description
To fall asleep, you count sheep down to zero. You can skip counts equal to any digit in the current number.

The sheep count currently has a value of $n$. To fall asleep, you must reduce this value exactly to $0$.
