...
## Description
A warehouse optimizes picking paths. Even-numbered bins should be filled with items sorted by weight ascending. Odd-numbered bins should be filled with items sorted by weight descending. Given the item weights, determine the bin allocation.
