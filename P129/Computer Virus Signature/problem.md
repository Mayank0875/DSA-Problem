...
## Description
An antivirus scanner checks how many times a malicious signature can be formed from a file's binary stream.

You are given two strings `target` and `source` consisting of hexadecimal characters.
...
- Strings consist of hexadecimal characters.
