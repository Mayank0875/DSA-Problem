...
## Description
A sawmill tracks the lengths of cut planks, sorted in inventory. A construction crew orders a specific length of wood. The inventory manager must calculate how many planks of that exact length are available.
