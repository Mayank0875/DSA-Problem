...
## Description
An artist mixes paints. Each tube has a pigment intensity. To get the perfect shade, two tubes must be mixed such that their combined intensity matches a target value. Count the number of tube pairs that can produce the perfect shade.
