...
## Description
A fleet of vehicles logs daily distances. A maintenance check is required for the sum of distances of vehicles that traveled an even number of miles. As logs are updated with new trips, report this sum.
