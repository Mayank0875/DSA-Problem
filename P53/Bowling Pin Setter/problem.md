...
## Description
A bowling pin setting machine scans a row. Standing pins are non-zero, and knocked-down pins are `0`. For a special practice mode, the machine sweeps all standing pins to the left side of the lane, pushing the empty spots to the right.
