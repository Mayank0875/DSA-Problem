...
## Description
A recipe calls for a specific spice blend strength. You have packets of spices with different strengths. You need to use exactly two packets to hit the target strength. Count the number of valid packet pairs.
