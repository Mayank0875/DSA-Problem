...
## Description
A router buffer holds valid packets (non-zero headers) and null packets (`0`) marked for discard. The router needs to compact the buffer by moving valid packets to the front to be processed, pushing nulls to the end.
