...
## Description
An analyst wants to smooth out daily stock price fluctuations. Calculate the k-day centered moving average for each day to identify long-term trends.

You are given a **0-indexed** array `nums` of `n` integers representing stock prices and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of stock prices.
