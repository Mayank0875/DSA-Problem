...
## Description
Biologists compare a mutated gene sequence with a healthy one (integer codes). They want to find the longest continuous segment that remains unmutated (identical). Calculate the length of this healthy segment.
