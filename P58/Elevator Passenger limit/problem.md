...
## Description
An elevator has a strict weight limit. For safety testing, engineers look for pairs of test weights that sum exactly to the maximum capacity. Given the available test weights, count the valid pairs for the test.
