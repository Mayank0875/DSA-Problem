...
## Description
A gardener has a long hedge where the bushes have grown to different heights. The owner wants a rectangular section cut into the side for a decorative feature. The rectangle must fit within the existing foliage. Determine the maximum area of this rectangular feature based on the current bush heights.
