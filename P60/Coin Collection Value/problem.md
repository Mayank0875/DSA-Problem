...
## Description
A numismatist arranges a display. Even slots hold coins sorted by value ascending. Odd slots hold coins sorted by value descending. Given the coin values, arrange the display.
