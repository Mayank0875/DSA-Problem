...
## Description
A music playlist contains songs (non-zero track IDs) and 'removed' tracks that show up as `0`. The media player has a 'Collapse' feature that moves all valid songs to the top of the queue, pushing the gaps (0s) to the bottom.
