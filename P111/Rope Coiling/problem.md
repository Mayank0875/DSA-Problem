...
## Description
A climber coils a rope. To uncoil it without tangles, the rope must be released in the reverse order it was wound.

The data is stored as a string `s`. To prepare the rope for climbing, you must reverse the string.
