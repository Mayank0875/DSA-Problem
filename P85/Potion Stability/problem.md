...
## Description
An alchemist has `n` ingredients with distinct volatility ratings. A stable potion can be brewed by mixing ingredients, but only if the GCD of their volatility ratings is exactly 1.

Your task:
Count how many non-empty subsequences of ingredients have a greatest common divisor (GCD) of their volatility ratings exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the volatility ratings.
