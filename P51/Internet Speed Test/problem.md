...
## Description
You perform a network speed test every hour. For each test, you want to know how many consecutive previous tests (including the current one) had a download speed less than or equal to the current speed. This helps identify periods of improving connection. Given the speed test results, calculate this value for each hour.
