...
## Description
A guide has a pile of equipment. They have a checklist for different excursions. An excursion is possible if the pile contains all the necessary gear items. Calculate the total gear count of all possible excursions.
