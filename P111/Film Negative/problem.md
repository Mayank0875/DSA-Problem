...
## Description
A film strip was scanned from the wrong end. The digital frames need to be reordered.

The data is stored as a string `s`. To correct the movie file, you must reverse the string.
