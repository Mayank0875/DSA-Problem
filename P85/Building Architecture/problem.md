...
## Description
An architect designs `n` pillars with different heights. For aesthetic balance (and math fun), they highlight groups of pillars where the GCD of heights is 1.

Your task:
Count how many non-empty subsequences of pillars have a greatest common divisor (GCD) of their heights exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the heights.
