...
## Description
You have a jar of candies with different flavors (IDs). You decide to eat exactly k candies. To stop yourself from wanting more variety later, you want to eliminate as many flavor types as possible from the jar. What is the least number of unique flavors remaining?
