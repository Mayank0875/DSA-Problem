...
## Description
A chef has a list of ingredients by ID. Rare ingredients (appearing less often in recipes) should be prepared first. If ingredient counts are the same, use the one with the higher ID first.
