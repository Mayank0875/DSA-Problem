...
## Description
Quality control checks a product line for a specific defect pattern sequence.

You are given two strings `target` and `source` consisting of status codes.
...
- Strings consist of status codes.
