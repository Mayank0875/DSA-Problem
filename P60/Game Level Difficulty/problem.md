...
## Description
A game designer balances a campaign. Even levels are sorted by difficulty rating ascending. Odd levels are sorted by difficulty rating descending. Given the ratings, sequence the levels.
