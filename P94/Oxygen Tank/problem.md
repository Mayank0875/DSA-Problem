...
## Description
An astronaut vents excess oxygen pressure. The vent releases psi equal to any digit in the current pressure reading.

The tank pressure currently has a value of $n$. To empty the tank, you must reduce this value exactly to $0$.
