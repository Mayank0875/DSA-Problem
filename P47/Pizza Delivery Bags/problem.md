...
## Description
A pizza place uses thermal bags for delivery. Each bag can hold at most two pizza boxes, and there is a size/weight limit for the bag. Given the 'size' values of the pending pizza orders, determine the minimum number of thermal bags the delivery driver needs.
