...
## Description
Two speech samples are converted into phonetic integer codes. A linguist wants to find the longest continuous phrase pronounced exactly the same way in both samples. Identify the length of this matching phonetic segment.
