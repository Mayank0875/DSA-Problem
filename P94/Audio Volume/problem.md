...
## Description
A sound engineer fades out a track. The fader reduces decibels by an amount equal to any digit in the current volume level.

The volume level currently has a value of $n$. To silence the audio, you must reduce this value exactly to $0$.
