...
## Description
A historian matches document fragments. Two fragments belong to the same scroll if their ID codes sum to a specific catalog number. Count the pairs of fragments that belong together.
