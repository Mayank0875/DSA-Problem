...
## Description
A bio-informatics tool organizes DNA fragments by molecular weight. Even positions in the sequence should have weights sorted ascending. Odd positions should have weights sorted descending. Given the weights, reorder the sequence.
