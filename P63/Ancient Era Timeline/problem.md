...
## Description
A history book has $n$ chapters. There are 5 distinct historical eras. The chapters must cover the eras in chronological order (non-decreasing). How many ways can the chapters be assigned to eras?
