...
## Description
An automated trading bot monitors a sorted list of historical stock prices. It is programmed to execute a strategy when the price hits or exceeds a certain target. The bot needs to find the index of the first historical record where the price was greater than or equal to the target.
