...
## Description
A spy finds a keypad with letters. To unlock the safe, they must swipe a pattern that spells out the pass-code. The swipe must connect adjacent keys. Given the keypad layout and the pass-code, determine if the code can be entered.
