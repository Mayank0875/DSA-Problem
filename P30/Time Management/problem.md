...
You are planning your day and have exactly $T$ minutes to fill. You have a list of tasks, each taking a specific number of minutes (e.g., 2, 3, 5). You can perform any task multiple times. Your task is to find the *total number* of unique combinations of tasks that will fill your schedule of $T$ minutes perfectly.
