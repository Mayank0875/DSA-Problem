...
## Description
A court expunges k traffic records. Records are categorized by violation ID. The goal is to clear the docket of minor, infrequent violation types. Find the minimum number of unique violation types remaining on record.
