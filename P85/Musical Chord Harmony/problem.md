...
## Description
A composer is selecting notes for a new chord. Each note has a frequency value. A 'Pure Chord' is defined as a set of notes where the GCD of their frequencies is 1.

Your task:
Count how many non-empty subsequences of notes have a greatest common divisor (GCD) of their frequencys exactly equal to 1.
