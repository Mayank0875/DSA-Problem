...
## Description
A facility has a heap of recyclable materials. They have orders for processed bundles. A bundle can be made if the heap has all the specific materials. Calculate the total material count of all makable bundles.
