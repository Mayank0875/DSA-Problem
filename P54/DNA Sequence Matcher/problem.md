...
## Description
In a bio-grid experiment, cells containing different DNA fragments are arranged in a matrix. Researchers want to find if a specific composite DNA sequence can be constructed by combining fragments from adjacent cells. Check if the sequence is formable.
