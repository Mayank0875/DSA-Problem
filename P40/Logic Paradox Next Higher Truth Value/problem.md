...
Logic Paradox: Next Higher Truth Value

## Slug

logic-paradox-next-higher-truth
...
A philosopher is cataloguing a sequence of paradoxical statements, each assigned a numeric “truth intensity”. For each statement, they wish to identify the intensity of the nearest subsequent statement that possesses a strictly higher truth intensity. This helps them trace escalating contradictions within the sequence. If no later statement has a higher intensity (either because it is the last one or all following statements have lower or equal intensity), this should be noted. Can you compute this for each statement?
