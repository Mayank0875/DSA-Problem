...
## Description
A spy has intercepted a message from a rival agency. The encryption is simple: the entire text string is just reversed.

The data is stored as a string `s`. To decode the intel, you must reverse the string.
