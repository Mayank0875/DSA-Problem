...
## Description
A health agency records daily pollen counts, sorted for seasonal analysis. To issue allergy warnings, they need to find the number of days where the pollen count was exactly at a specific threshold.
