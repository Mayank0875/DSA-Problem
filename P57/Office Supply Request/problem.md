...
## Description
An office manager has a cabinet of supplies. They have a list of employee requests. A request can be fulfilled if the cabinet has all the items. Calculate the total item count of all fulfillable requests.
