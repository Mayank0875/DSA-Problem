...
## Description
An astronomer records `n` meteors with different mass estimates. A specific cluster type is defined by meteors whose masses have a GCD of 1.

Your task:
Count how many non-empty subsequences of meteors have a greatest common divisor (GCD) of their masss exactly equal to 1.
...
## Input Format
- The first line contains an integer n (the number of meteors).
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the masss.
