...
## Description
A starship navigates through a sector grid of space anomalies. The captain plots a course through a specific sequence of anomaly types to mask the ship's signature. The ship moves to adjacent sectors. Verify if the course is navigable.
