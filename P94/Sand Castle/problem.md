...
## Description
Waves wash away a sandcastle. Each wave removes grains equal to any digit in the current grain count.

The grain count currently has a value of $n$. To flatten the castle, you must reduce this value exactly to $0$.
