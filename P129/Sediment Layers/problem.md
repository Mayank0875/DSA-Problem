...
## Description
Geologists count occurrences of a specific geological era sequence in a core sample.

You are given two strings `target` and `source` consisting of rock types.
