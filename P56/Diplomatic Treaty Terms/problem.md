...
## Description
Historians compare two treaties represented by clause IDs. They want to find the longest continuous section of clauses that is identical in both documents. Calculate the number of clauses in this section.
