...
## Description
An astronomer maps the sky as a grid of stars, each labeled with a spectral type (letter). A prophecy speaks of a specific constellation pattern formed by connecting adjacent stars. Check if this stellar pattern exists in the mapped sector of the sky.
