...
## Description
You are bagging heavy grocery items. To prevent tearing, each paper bag has a weight limit. You also decide not to put more than two heavy items in any single bag. Given the weights of the items, determine the minimum number of bags required.
