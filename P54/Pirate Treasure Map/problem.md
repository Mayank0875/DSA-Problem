...
## Description
A treasure map has a grid of landmarks. The instructions say to follow a path of specific landmarks (e.g., 'Tree', 'Rock', 'Cave' represented by letters). You can only walk between adjacent landmarks. Check if the instructions lead to a valid path on the map.
