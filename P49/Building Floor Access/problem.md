...
## Description
An elevator system has a list of accessible floors sorted by height. A drone delivering a package needs to reach a specific altitude. The drone must dock at the first floor that is at or above the target altitude. Find the index of this floor in the sorted list.
