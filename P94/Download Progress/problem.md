...
## Description
A download bar shows remaining bytes. A booster reduces remaining bytes by any digit in the current count.

The remaining bytes currently has a value of $n$. To finish the download, you must reduce this value exactly to $0$.
