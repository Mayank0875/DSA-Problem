...
## Description
A weather app records the daily maximum UV index. For each day, it calculates a 'radiation streak', defined as the number of consecutive previous days (including the current one) where the UV index was less than or equal to today's index. Given the UV data, calculate this streak for each day.
