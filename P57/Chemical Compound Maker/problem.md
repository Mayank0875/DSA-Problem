...
## Description
A chemist has a supply of atoms. They have a database of chemical formulas. Determine which compounds can be synthesized using the available atoms. Return the sum of the atomic counts (lengths) of all valid compounds.
