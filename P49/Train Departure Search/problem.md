...
## Description
A commuter is checking a digital timetable at the train station. The screen lists the departure times (in minutes from midnight) of all trains heading to the city center, sorted chronologically. The commuter arrives at the platform at a specific time. You need to find the index of the first train that departs at or after the commuter's arrival time.
