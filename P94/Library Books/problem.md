...
## Description
A librarian shelves books. They can shelve a batch size equal to any digit in the current unshelved count.

The unshelved books currently has a value of $n$. To finish shelving, you must reduce this value exactly to $0$.
