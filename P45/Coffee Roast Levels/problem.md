...
## Description
A coffee distributor classifies beans by roast level (a numerical scale), sorted in inventory. A cafe owner asks for the availability of a specific roast level. You must count the number of batches available for that level.
