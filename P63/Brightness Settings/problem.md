...
## Description
A screen performs a calibration sequence of $n$ steps. There are 5 brightness settings. The brightness must never decrease during calibration. How many sequences are valid?
