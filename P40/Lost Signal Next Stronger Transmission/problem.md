...
A communications team is analyzing the strength of received signals over time to anticipate the next stronger transmission. For each recorded signal, they want to identify the strength of the nearest future signal that had a strictly higher strength. This helps them understand signal variability or pinpoint moments of improved reception. If no future signal had higher strength (either because it was the last record or all subsequent signals had lower or equal strength), this should be noted. Can you calculate this for each signal?
