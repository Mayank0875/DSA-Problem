...
## Description
An OS scheduler monitors CPU usage percentages. It smooths the load data to make decisions about thread allocation.

You are given a **0-indexed** array `nums` of `n` integers representing usage percentages and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of usage percentages.
