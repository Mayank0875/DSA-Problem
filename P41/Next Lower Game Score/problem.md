...
## Description
You are analyzing the leaderboard scores of a player over several matches. For each match score, you want to identify the score of the nearest future match where they performed strictly worse. This identifies slumps immediately after good performances. Given the list of scores, find the next lower score for each match. If the player maintains or improves their score in all future matches, report -1.
