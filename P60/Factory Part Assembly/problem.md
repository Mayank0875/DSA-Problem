...
## Description
An assembly line organizes parts. Even slots on the belt must carry parts sorted by size ascending. Odd slots must carry parts sorted by size descending. Given the part sizes, arrange them on the belt.
