...
## Description
A builder sorts bricks by shape ID. Rare shapes needed for the build are set aside first. If shape counts are equal, the shape with the higher ID is set aside first.
