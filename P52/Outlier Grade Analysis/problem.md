...
## Description
A teacher is analyzing exam scores. Scores that appear very rarely might indicate outliers (exceptionally good or bad performance). Sort the list of scores so that the least common scores appear first. If two scores have the same frequency, place the higher score first.
