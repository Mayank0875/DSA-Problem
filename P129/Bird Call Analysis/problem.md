...
## Description
An ornithologist identifies a specific bird call sequence hidden within a noisy forest recording.

You are given two strings `target` and `source` consisting of phonetic symbols.
...
- Strings consist of phonetic symbols.
