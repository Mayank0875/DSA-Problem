...
## Description
In a reverse auction, bids come in sequentially. For analytical purposes, you want to match each bid with the value of the nearest subsequent bid that is strictly lower. This helps understand how quickly the price is being driven down. Given the stream of bid amounts, find the next lower bid for each entry. If no lower bids occur later in the auction, indicate this result.
