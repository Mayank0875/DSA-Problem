...
## Description
A signal bounced off the moon and returned. The reflection caused the phase of the data string to invert temporally.

The data is stored as a string `s`. To reconstruct the original transmission, you must reverse the string.
