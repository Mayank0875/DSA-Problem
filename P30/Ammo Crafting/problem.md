...
You are crafting special ammo that requires exactly $T$ units of "volatile powder". You have $N$ different components, each providing a certain amount of powder (e.g., 2, 3, 5). You have an infinite supply of each component. How many *total unique combinations* of components can you use to get exactly $T$ powder?
