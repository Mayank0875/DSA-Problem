...
## Description
Old game consoles appreciate in value. A collector tracks the price of a specific unit. They want to buy it and sell it later. Given the yearly price averages, find the maximum profit.
