...
## Description
A spider web is modeled as a grid of intersections. A fly's struggle sends a vibration pattern through adjacent intersections. Given the grid of intersection types and the vibration pattern sequence, determine if the signal could travel that path.
