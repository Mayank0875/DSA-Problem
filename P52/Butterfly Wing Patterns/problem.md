...
## Description
An entomologist displays butterflies by wing pattern ID. Rare patterns are pinned first. If multiple patterns have the same count, the one with the higher ID is pinned first.
