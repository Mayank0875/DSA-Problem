...
## Description
A developer fixes k bugs in a sprint. Bugs are by category ID. They focus on clearing out entire categories of minor bugs. Determine the minimum number of unique bug categories remaining.
