...
## Description
A skyscraper security system logs access requests by floor number, sorted by floor. A guard wants to find the first log entry for a specific floor. Given the sorted list of floor numbers, find the index of the first occurrence of the target floor.
