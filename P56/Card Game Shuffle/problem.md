...
## Description
A magician compares two decks of cards (represented by card IDs) after shuffling. They want to find the longest continuous run of cards that remained in the same relative order in both decks. Calculate the length of this run.
