...
## Description
A scrapyard owner tracks the price of copper per ton. They want to buy a shipment and sell it later when the market peaks. Given the daily copper prices, calculate the maximum profit.
