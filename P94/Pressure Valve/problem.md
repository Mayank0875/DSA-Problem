...
## Description
A tank is over-pressurized. The relief valve releases pressure equal to any digit in the current PSI reading.

The tank pressure currently has a value of $n$. To normalize the tank, you must reduce this value exactly to $0$.
