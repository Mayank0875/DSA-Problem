...
## Description
A wizard sorts magic scrolls by spell level. Rare scrolls (few copies) are placed on the top shelf. If two spells have the same number of copies, the higher level spell is placed first.
