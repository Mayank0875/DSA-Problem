...
## Description
A diplomatic database logs treaty IDs signed by countries. A bilateral treaty involves exactly two signatures (entries). Multilateral treaties have more. The archivist wants to filter out the IDs of all treaties that are strictly bilateral. Given the log of treaty signatures, return the IDs of those signed exactly twice.
