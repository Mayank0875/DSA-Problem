...
## Description
A collector sells exactly k stamps from their album. Stamps are identified by country codes. The collector wants to stop collecting from certain countries entirely. Determine the minimum number of unique country codes remaining in the album.
