...
## Description
A video buffer contains data frames (non-zero) and dropped frames (`0`). To ensure smooth playback, the player software shifts all valid data frames to the start of the buffer, moving the null space (`0`s) to the end to be overwritten by new data.
