...
## Description
Two colleagues compare their busy/free slots (represented by activity codes). They want to find the longest continuous block of time where their schedules have the exact same activity pattern. Find the duration (in slots) of this match.
