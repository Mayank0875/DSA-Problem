...
## Description
A transformer steps down voltage. It can reduce volts by an amount equal to any digit in the current voltage reading.

The voltage currently has a value of $n$. To power off the device, you must reduce this value exactly to $0$.
