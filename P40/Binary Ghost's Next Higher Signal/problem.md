...
Binary Ghost's Next Higher Signal

## Slug

binary-ghost-next-higher-signal
...
A Binary Ghost roams the digital realm, observing a sequence of signal strengths emitted by haunted circuits. For each signal, the ghost wants to know the strength of the nearest future signal that is strictly higher. This helps the ghost track rising energy patterns and locate the most potent hauntings. If no future signal is higher (either because it is the last signal or all subsequent signals are lower or equal), this should be recorded. Can you determine this for every signal in the sequence?
