...
## Description
An SEO expert looks at search term IDs. Unique, niche search terms (low frequency) are valuable. Sort the terms so that the least frequent ones appear first. If frequencies match, place the higher term ID first.
