...
## Description
The value of a rookie baseball card changes based on player performance. An investor wants to buy the card and sell it later. Given the weekly price index, calculate the maximum profit.
