...
## Description
A computer virus spreads through a memory grid. Analysts want to know if the virus could have executed a specific payload sequence by infecting adjacent memory cells. Check if the payload sequence matches the grid layout.
