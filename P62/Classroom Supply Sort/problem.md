...
## Description
A teacher throws away k dried-out markers. Markers are by color ID. They toss the colors that only had one or two left. Calculate the minimum number of unique colors remaining.
