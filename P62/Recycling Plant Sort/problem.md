...
## Description
A plant processes k tons of material. Material is by type ID. They process the small batches first. Calculate the minimum number of unique material types left in the yard.
