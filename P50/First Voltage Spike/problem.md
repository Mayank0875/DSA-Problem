...
## Description
An electrical grid monitor records voltage readings sorted by value for statistical analysis. An engineer wants to investigate the first instance (lowest index in the sorted log) where a specific voltage value was recorded. Return the index of the first occurrence of the target voltage.
