...
## Description
A secure vault has `n` slots requiring numeric keys. The vault opens if the user inserts keys whose numerical values have a GCD of 1.

Your task:
Count how many non-empty subsequences of keys have a greatest common divisor (GCD) of their values exactly equal to 1.
