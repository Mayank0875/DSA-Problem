...
## Description
A light show is planned for a waterfall that flows over a stepped cliff face. The cliff face is composed of vertical rock segments of different heights. You want to project a rectangular image onto the falling water. The image must fit within the bounds of the rock face behind the water. Calculate the maximum projection area.
