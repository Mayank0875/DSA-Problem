...
## Description
A logistics company monitors daily fuel prices. For cost analysis, they calculate a streak for each day: the count of consecutive days ending today where the fuel price was less than or equal to today's price. Given the list of daily prices, compute this streak for every day.
