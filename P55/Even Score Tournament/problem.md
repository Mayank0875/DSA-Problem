...
## Description
In a quirky board game tournament, a team's total power is derived only from players who currently have an even score. As the game progresses and players gain or lose points, you must update the scoreboard by summing the scores of all players who currently hold an even number of points.
