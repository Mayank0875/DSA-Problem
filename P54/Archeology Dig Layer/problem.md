...
## Description
An excavation site is a grid. Archaeologists look for a timeline represented by a sequence of artifact layers. They dig through adjacent sections. Determine if the timeline is preserved in the site.
