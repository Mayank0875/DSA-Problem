...
Memory Fracture: Next Higher Memory Value

## Slug

memory-fracture-next-higher-value
...
A researcher is analyzing a series of memory fragment intensities to understand how memories evolve over time. For each fragment, they want to identify the intensity of the nearest future fragment that has a strictly higher intensity. This helps reveal patterns of memory strengthening or highlight particularly salient moments. If no future fragment has a higher intensity (either because it is the last fragment or all subsequent fragments have lower or equal intensity), this should be noted. Can you compute this for each fragment?
