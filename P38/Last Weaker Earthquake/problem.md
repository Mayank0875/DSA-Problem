...
## Description
You are a seismologist analyzing a sequence of aftershocks following a major event. You have the magnitude of each shock listed in order of occurrence. To understand the decay or resurgence of seismic activity, you want to find the magnitude of the nearest previous shock that was strictly weaker than the current one. This helps in identifying local intensifications. For each shock magnitude, you need to determine the value of the most recent prior shock that was strictly smaller. If all previous shocks were stronger or equal, you should report that no such shock exists. Your task is to process the list of earthquake magnitudes.
