...
## Description
An electronics student needs to create a specific resistance value by connecting two resistors in series (adding their values). Given a box of resistors, count the number of pairs that result in the desired total resistance.
