...
## Description
A composer has a set of available notes on their instrument. They have a book of melodies. A melody can be played if the instrument can produce all the required notes. Calculate the total note count of all playable melodies.
