...
## Description
An assembly line has parts (IDs) and spaces (`0`). A pneumatic pusher activates, sliding all parts to the start of the conveyor segment, ensuring the empty spaces are grouped at the end.
