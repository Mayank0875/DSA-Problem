...
## Description
A smartphone home screen grid (linearized) has active apps (non-zero IDs) and empty slots (`0`) where apps were uninstalled. The 'Auto-Arrange' feature slides all icons to the top-left (start of array), pushing all empty slots to the end.
