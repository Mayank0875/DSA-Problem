...
## Description
A hacker has captured a set of keystrokes. They have a list of common passwords. Determine which passwords could possibly be typed using the captured keystrokes. Return the sum of lengths of all plausible passwords.
