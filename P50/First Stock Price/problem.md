...
## Description
A financial report lists historical stock prices sorted by value. An analyst wants to identify the first entry in this sorted list that corresponds to a specific price point. Given the sorted prices, find the index of the first occurrence of the target price.
