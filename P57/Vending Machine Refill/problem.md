...
## Description
A vending machine tech has a bag of snack items (codes). They have a list of slot configurations to fill. A slot can be filled if the bag contains the specific items required. Calculate the total item count of all fillable slots.
