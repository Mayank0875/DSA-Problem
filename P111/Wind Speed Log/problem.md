...
## Description
An anemometer records wind gusts. Turbine operators use a smoothed wind speed average to adjust blade angles.

You are given a **0-indexed** array `nums` of `n` integers representing wind speeds and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of wind speeds.
