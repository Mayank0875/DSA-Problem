...
## Description
An influencer analyzes the performance of their posts. The number of likes on each post is listed in sorted order. They want to know how many posts achieved a specific engagement number.
