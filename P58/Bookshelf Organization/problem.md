...
## Description
A librarian wants to fill a shelf gap of a specific width using exactly two books. Given the widths of all available books, count the number of pairs of books that fit perfectly side-by-side to fill the gap.
