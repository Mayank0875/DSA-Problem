...
## Description
A market crash simulation. The price drops by dollars equal to any digit in the current stock price.

The stock price currently has a value of $n$. To bankrupt the company, you must reduce this value exactly to $0$.
