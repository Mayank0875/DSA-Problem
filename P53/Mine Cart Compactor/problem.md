...
## Description
In a mine, a train of carts carries ore. Full carts have a positive weight, while empty carts are marked `0`. To improve stability, the foreman wants to shunt all full carts to the front of the train and move the empties to the caboose end.
