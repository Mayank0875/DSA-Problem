...
## Description
A radio scanner has a list of saved station frequencies, sorted in ascending order. The user turns the dial to a specific frequency. The radio should snap to the nearest saved station that is at or above the dialed frequency. Find the index of this station.
