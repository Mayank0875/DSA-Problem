...
Monthly sales figures for a new product are given. The sales ramp up, hit a peak month, and then taper off, forming a "mountain array".
    1. n >= 3
    2. `sales[0] < sales[1] < ... < sales[i-1] < sales[i]`
    3. `sales[i] > sales[i+1] > ... > sales[n-1]`

Find the index of the peak sales month.
