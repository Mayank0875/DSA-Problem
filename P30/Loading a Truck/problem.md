...
You are loading a truck and must reach an exact total weight of $T$. You have several types of crates, each with a different weight (e.g., 2, 3, 5). You have an unlimited supply of each crate type. Your task is to find the *total number* of unique combinations of crates that will sum exactly to the target weight $T$.
