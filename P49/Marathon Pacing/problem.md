...
## Description
Race officials have a list of expected finish times for elite runners, sorted ascendingly. To assign pacer groups, they need to find the index of the first runner whose expected time is greater than or equal to a specific pacing target.
