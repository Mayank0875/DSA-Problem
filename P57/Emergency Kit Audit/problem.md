...
## Description
A safety officer has a supply room. They have checklists for emergency kits. A kit is complete if the room has all the items. Calculate the total item count of all completeable kits.
