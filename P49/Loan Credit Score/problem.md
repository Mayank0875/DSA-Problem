...
## Description
A bank has a sorted list of applicant credit scores. They want to determine the cut-off point for a new premium card product. Given a target minimum score, find the index of the first applicant who qualifies for the premium card.
