...
## Description
Looking into a magical pool reveals the truth, but the vision is a reflection. Text appearing in the water is backward.

The data is stored as a string `s`. To read the prophecy, you must reverse the string.
