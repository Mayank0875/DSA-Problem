...
## Description
To check if a word is a palindrome, a student decides to reverse the word and compare it to the original.

The data is stored as a string `s`. To prepare the string for comparison, you must reverse the string.
