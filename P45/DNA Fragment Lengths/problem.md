...
## Description
In a genetics lab, DNA fragments are separated by length using electrophoresis. The lengths are recorded in a sorted array. A researcher needs to count the abundance of fragments of a specific length.
