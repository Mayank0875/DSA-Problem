...
## Description
Archaeologists are studying a ruined aqueduct. The remaining pillars stand at different heights. They want to estimate how much water the structure could theoretically hold in the gaps between pillars if the bottom was sealed. Given the heights of the surviving pillars, calculate the total water capacity.
