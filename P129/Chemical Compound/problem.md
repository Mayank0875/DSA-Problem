...
## Description
A chemist counts the formations of a molecule chain from a solution of random atoms.

You are given two strings `target` and `source` consisting of element symbols.
...
- Strings consist of element symbols.
