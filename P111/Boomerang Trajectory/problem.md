...
## Description
A smart boomerang records its flight path. The return path is the exact reverse of the outbound path.

The data is stored as a string `s`. To analyze the return flight, you must reverse the string.
