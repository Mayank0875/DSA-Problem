...
## Description
A sommelier has `n` bottles with different vintage years. A tasting flight is curated by selecting bottles whose years (as numbers) have a GCD of 1.

Your task:
Count how many non-empty subsequences of bottles have a greatest common divisor (GCD) of their vintage years exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the vintage years.
