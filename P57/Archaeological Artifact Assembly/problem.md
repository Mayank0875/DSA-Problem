## Title
Archaeological Artifact Assembly
...
## Description
An archaeologist has a collection of shards. They have diagrams of ancient pots. A pot can be reconstructed if the collection contains all the matching shards. Calculate the total shard count of all reconstructible pots.
