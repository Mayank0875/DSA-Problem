...
## Description
A warehouse manager is clearing out stock. They can ship out items in batches equal to any digit in the current stock count.

The inventory count currently has a value of $n$. To clear the warehouse, you must reduce this value exactly to $0$.
