...
## Description
A calendar application tracks recurring event IDs. The user wants to see a list of events that occurred exactly twice in the past year (bi-annual meetings). Given the list of event IDs recorded, return the IDs of those that happened exactly two times.
