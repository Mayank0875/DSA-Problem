...
## Description
Two subway lines are represented by sequences of station IDs. A commuter wants to find the longest continuous section where both lines stop at the same stations in the same order. Find the number of stations in this shared section.
