...
## Description
An auditor is looking for errors. A transaction is considered verified if two entries in the ledger sum up to a control value (often zero or a specific balance). Count the number of pairs of entries that verify the control value.
