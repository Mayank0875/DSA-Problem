...
## Description
A geneticist wants to find how many times a specific gene marker appears as a subsequence in a DNA sample.

You are given two strings `target` and `source` consisting of characters 'A', 'C', 'G', 'T'.
...
- Strings consist of characters 'A', 'C', 'G', 'T'.
