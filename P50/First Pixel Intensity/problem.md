...
## Description
An image histogram lists pixel intensity values sorted from dark to light. An editor wants to find the first pixel index that has a specific intensity value. Given the sorted intensities, return the index of the first occurrence of the target.
