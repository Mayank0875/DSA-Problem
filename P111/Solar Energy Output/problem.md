...
## Description
Solar panels have fluctuating output due to passing clouds. Engineers calculate the average power generation over small windows to estimate grid capacity.

You are given a **0-indexed** array `nums` of `n` integers representing power outputs and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of power outputs.
