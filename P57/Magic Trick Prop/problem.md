...
## Description
A magician has a trunk of props. They have a book of tricks. A trick can be performed if the trunk has all the specific props. Calculate the total prop count of all performable tricks.
