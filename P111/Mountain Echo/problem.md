...
## Description
You shout into a canyon. The echo returns your voice, but due to acoustic anomalies, the syllables are flipped.

The data is stored as a string `s`. To understand the echo, you must reverse the string.
