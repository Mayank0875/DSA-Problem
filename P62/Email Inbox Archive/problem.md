...
## Description
An automated script archives k emails. Emails are tagged by sender ID. The script prioritizes removing emails from senders with few messages to clean up the contact list. Determine the minimum number of unique senders remaining in the inbox.
