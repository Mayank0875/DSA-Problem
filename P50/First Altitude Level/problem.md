...
## Description
A drone flight log records altitude readings sorted from lowest to highest. To calibrate the sensors, an engineer needs to find the first reading that matches a specific target altitude. Return the index of the first occurrence of this altitude.
