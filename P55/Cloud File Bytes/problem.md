...
## Description
A storage system indexes files. A compression routine runs on files with an even byte count. As files are modified, report the total size of all files currently queued for compression.
