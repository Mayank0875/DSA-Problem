...
## Description
A hospital ward row has occupied beds (patient IDs) and empty beds (`0`). The nurse manager wants to consolidate patients to the rooms nearest the station (start of array), moving empty beds to the far end of the hall.
