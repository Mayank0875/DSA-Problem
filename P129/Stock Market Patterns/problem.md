...
## Description
An analyst looks for a specific 'buy-sell-hold' pattern sequence within a long history of trading signals.

You are given two strings `target` and `source` consisting of characters 'B', 'S', 'H'.
...
- Strings consist of characters 'B', 'S', 'H'.
