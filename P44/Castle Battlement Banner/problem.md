...
## Description
A medieval castle has battlements (merlons) of varying heights. The King wants to hang a rectangular banner from the battlements. The banner must be supported by the stone structure behind it. Given the heights of the merlons, find the maximum area of the banner.
