...
## Description
A box office tracks sales for different shows. Shows with an even number of tickets sold get a marketing boost. As sales occur or are refunded, calculate the total tickets sold for shows receiving the boost.
