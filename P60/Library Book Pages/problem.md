...
## Description
A binder is creating a custom anthology. Chapters placed at even indices in the table of contents should be sorted by page count ascending. Chapters at odd indices should be sorted by page count descending. Given the page counts of the chapters, order them correctly.
