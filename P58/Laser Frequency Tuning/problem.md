...
## Description
A lab uses two lasers to create an interference pattern. The sum of their frequencies must match a target resonance. Given available laser settings, count the valid tuning pairs.
