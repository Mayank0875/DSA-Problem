...
## Description
A DJ has a playlist but needs to shorten it by removing exactly k songs. Songs are identified by artist IDs. The DJ wants the remaining playlist to feature as few distinct artists as possible for consistency. Find the minimum number of artists remaining.
