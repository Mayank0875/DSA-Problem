...
## Description
Books are placed on a special display shelf. Even positions hold books sorted by ID ascending. Odd positions hold books sorted by ID descending. Given the book IDs, show the shelf order.
