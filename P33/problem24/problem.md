...
A cross-section of a sand dune is measured at `n` points. The profile forms a "mountain array", where the sand slopes up to a single peak and then slopes down.
    1. n >= 3
    2. `h[0] < h[1] < ... < h[i-1] < h[i]`
    3. `h[i] > h[i+1] > ... > h[n-1]`

Find the index of the dune's highest point.
