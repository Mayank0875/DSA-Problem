...
## Description
A map lists peaks. Even index peaks are sorted by altitude ascending. Odd index peaks are sorted by altitude descending. Given the altitudes, format the list.
