...
## Description
An archaeologist translates a stone rubbing. The ancient civilization wrote their sentences from right to left.

The data is stored as a string `s`. To translate the text to modern format, you must reverse the string.
