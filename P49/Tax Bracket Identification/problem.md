...
## Description
A tax software has a list of income thresholds that define tax brackets, sorted in ascending order. To calculate the correct tax rate for a user, the system needs to find the first threshold that is greater than or equal to the user's taxable income.
