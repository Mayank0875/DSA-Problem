...
## Description
An encryption key degrades over time. You can manually weaken it by reducing its strength value by any of its digits.

The key strength currently has a value of $n$. To break the encryption, you must reduce this value exactly to $0$.
