...
## Description
A fraud detection system looks for a pattern of small purchases in a customer's history.

You are given two strings `target` and `source` consisting of transaction codes.
...
- Strings consist of transaction codes.
