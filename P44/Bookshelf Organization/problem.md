...
## Description
A librarian has arranged books of varying heights on a long shelf without any gaps. They want to place a large rectangular sticker across the spines of a contiguous group of books to label a genre. The sticker's height is limited by the shortest book in the selected group. Determine the maximum area of the sticker that can be applied.
