...
## Description
A chef removes k dishes from the daily prep list. Dishes are by ID. They remove the least popular ones to simplify the menu. Determine the minimum number of unique dishes left.
