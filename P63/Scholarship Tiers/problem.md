...
## Description
A foundation awards $n$ scholarships annually. There are 5 funding tiers. The list of recipients is published sorted by tier amount (non-decreasing). How many different funding distributions are possible?
