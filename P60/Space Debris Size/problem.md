...
## Description
A satellite tracks debris. Even tracking indices monitor debris sorted by size ascending. Odd indices monitor debris sorted by size descending. Given the debris sizes, update the tracking log.
