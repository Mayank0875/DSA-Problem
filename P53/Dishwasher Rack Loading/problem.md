...
## Description
A dishwasher rack has slots for plates. Dirty plates are non-zero integers (representing size), and empty slots are `0`. Before starting the cycle, a mechanism slides all plates to the front of the rack for better water coverage, leaving the empty slots at the back.
