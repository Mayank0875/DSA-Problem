...
## Description
An architect is designing a glass viewing panel for a swimming pool. The deep end of the pool has a floor with varying depths. The glass panel will be rectangular and installed vertically against the water profile. Given the depth measurements at regular intervals, find the maximum area of the rectangular glass panel.
