...
## Description
A computer system uses a peculiar endianness where the binary string representation of data is stored in reverse order.

The data is stored as a string `s`. To process the data correctly, you must reverse the string.
