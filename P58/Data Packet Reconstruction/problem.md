...
## Description
A network receiver has a buffer of data fragments, each with a specific size. To reconstruct a full packet, two fragments must be combined such that their total size equals the standard packet size protocol. Count the number of pairs of fragments that satisfy this protocol.
