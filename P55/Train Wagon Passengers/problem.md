...
## Description
A train has multiple wagons. A conductor collects tickets only from wagons with an even number of passengers. As people board or alight, calculate the total number of passengers in wagons that need ticket collection.
