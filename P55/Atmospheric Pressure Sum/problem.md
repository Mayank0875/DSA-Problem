...
## Description
Meteorologists track pressure readings. A theoretical model sums the pressure of all stations reporting an even reading. As pressures fluctuate, update the model's total sum after each reading change.
