...
## Description
A SETI researcher receives a stream of signals (characters). They have a dictionary of known alien words. Determine which words can be formed from the signal stream. Return the sum of lengths of all decipherable words.
