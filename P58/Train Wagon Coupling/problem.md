...
## Description
A train engine can pull a specific total weight. The yard master couples two wagons at a time. Count the pairs of wagons whose combined weight matches the engine's optimal load exactly.
