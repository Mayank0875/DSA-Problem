...
## Description
Pharma companies trade data on gene sequences. The value of a specific sequence changes based on research news. You want to buy the data rights and sell later. Given the weekly valuation, find the max profit.
