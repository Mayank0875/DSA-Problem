...
## Description
A fantasy league scores players based on a stat. Only players with an even stat value contribute to the 'Bonus Pool'. As stats are updated live during a game, calculate the total value of the Bonus Pool.
