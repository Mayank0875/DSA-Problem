...
## Description
A child has a bowl of alphabet soup. They want to spell out names of animals. Calculate the total length of all animal names that can be spelled using the letters floating in the soup.
