...
## Description
A jeweler has a tray of loose beads and charms. They have a catalog of bracelet designs. A bracelet can be made if the tray holds all the required components. Calculate the total bead count of all possible bracelets.
