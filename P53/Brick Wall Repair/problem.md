...
## Description
A row of bricks has solid bricks (non-zero strength) and missing mortar gaps (`0`). A mason wants to slide the existing bricks together to close the gaps, maintaining their pattern, and leave the empty space at the end of the wall for new bricks.
