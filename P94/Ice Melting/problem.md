...
## Description
An ice block melts. The heater reduces mass by grams equal to any digit in the current mass reading.

The ice mass currently has a value of $n$. To melt the ice, you must reduce this value exactly to $0$.
