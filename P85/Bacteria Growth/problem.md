...
## Description
A lab has `n` petri dishes with different colony counts. A diverse experiment group is selected if the colony counts have a GCD of 1.

Your task:
Count how many non-empty subsequences of dishes have a greatest common divisor (GCD) of their colony counts exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the colony counts.
