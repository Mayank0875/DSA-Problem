...
## Description
A hot air balloon descends. The pilot releases gas volume equal to any digit in the current volume meter.

The gas volume currently has a value of $n$. To land the balloon, you must reduce this value exactly to $0$.
