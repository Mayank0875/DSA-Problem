...
## Description
A social network has `n` users with different friend counts. An 'influencer circle' is defined as a group where the users' friend counts have a GCD of 1.

Your task:
Count how many non-empty subsequences of users have a greatest common divisor (GCD) of their friend counts exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the friend counts.
