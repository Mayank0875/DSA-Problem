...
Next Brighter Color in the Shattered Spectrum

## Slug

next-brighter-color-shattered-spectrum
...
A researcher is studying the fragments of a shattered light spectrum. For each fragment, they want to identify the intensity value of the nearest future fragment that has a strictly higher intensity. This helps them understand how the spectrum reassembles or where particularly bright fragments appear. If no future fragment has a higher intensity (either because it is the last fragment or all subsequent fragments have lower or equal intensity), this should be noted. Can you calculate this for each fragment?
