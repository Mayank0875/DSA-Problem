...
## Description
In a busy downtown area, pedicabs transport people. Each pedicab holds two passengers max and the driver has a weight limit they can pull. Given the weights of the passengers waiting, calculate the minimum number of pedicab trips needed.
