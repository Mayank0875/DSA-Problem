...
You are an interstellar trader. An alien merchant demands a payment of exactly $T$ "credits". You only have $N$ types of valuable ingots, worth different amounts (e.g., 2, 3, 5 credits). You have an unlimited supply of each ingot. How many *total unique combinations* of ingots can you use to pay the $T$ credits exactly?
