...
## Description
Rocket engineers test engine stages. Stages with an even thrust rating are cleared for launch. As tuning adjustments change thrust values, calculate the total thrust of all cleared stages.
