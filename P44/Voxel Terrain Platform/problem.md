...
## Description
In a voxel-based video game, you have a terrain slice represented by columns of voxels of different heights. You want to build a flat, rectangular landing platform on top of a contiguous section of these columns. However, to be stable, the platform must sit flush on the voxels. In this 2D slice view, finding the platform is equivalent to finding the largest rectangle in the histogram. Calculate its area.
