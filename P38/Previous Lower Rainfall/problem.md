...
## Description
You are a climate scientist studying daily rainfall amounts during the monsoon season. You have a list of rainfall measurements in millimeters. To analyze the intensity of recent storms, you want to find the rainfall amount of the nearest previous day that was strictly lower than the current day's rainfall. This helps in contrasting heavy rain days with recent drier days. For each daily measurement, your objective is to find the value of the closest preceding day where the rainfall was strictly less. If all previous days had more or equal rain, you must indicate that no lower value exists. Your task is to process the rainfall data.
