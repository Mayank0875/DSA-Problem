...
## Description
Race results list the finish times (rounded to the nearest minute) of all runners, sorted from first to last. The organizers want to know how many runners finished at a specific time mark.
