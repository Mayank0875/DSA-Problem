...
## Description
An auto-gain control system monitors input volume. It adjusts levels based on the average volume to prevent clipping.

You are given a **0-indexed** array `nums` of `n` integers representing volume levels and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of volume levels.
