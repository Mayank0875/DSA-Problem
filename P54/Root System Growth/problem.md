...
## Description
A plant's roots grow through a soil grid. Biologists track if a root could follow a specific nutrient path. The root grows into adjacent soil blocks. Verify if the growth path is supported by the soil grid.
