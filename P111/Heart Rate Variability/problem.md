...
## Description
A medical device monitors heartbeats. To avoid false alarms from movement artifacts, it calculates the rolling average of heart rates.

You are given a **0-indexed** array `nums` of `n` integers representing heart rates and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of heart rates.
