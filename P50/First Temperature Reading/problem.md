...
## Description
A weather station archives daily high temperatures, sorted from coldest to hottest. A climatologist wants to find the index of the first day in this sorted record that hit a specific temperature. Return the index of the first occurrence of the target temperature.
