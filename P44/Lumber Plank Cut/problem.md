...
## Description
A sawmill has glued together several pieces of wood of varying lengths to form a rough board. To sell it as a premium plank, they need to cut it into a perfect rectangle. Given the lengths of the adjacent wood pieces, determine the maximum area of the rectangular plank that can be cut from the rough board.
