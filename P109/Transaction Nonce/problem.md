...
## Description
In a distributed ledger, each transaction from a wallet must have a unique nonce. Duplicates are rejected.
...
## Input Format
- The first line contains a single integer n, the number of txs.
