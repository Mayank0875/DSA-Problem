...
## Description
A climate lab records temperatures from various sensors. A calibration check sums the values of all sensors reading an even temperature. As temperatures drift up or down, update the calibration sum after each reading change.
