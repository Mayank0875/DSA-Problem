...
## Description
A lab needs to dispose of k vials of chemicals. Chemicals are identified by formula IDs. Safety protocols suggest minimizing the variety of chemicals stored. Calculate the minimum number of unique chemical types left after disposal.
