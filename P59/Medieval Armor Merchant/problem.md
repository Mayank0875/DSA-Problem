...
## Description
A blacksmith tracks the price of steel plate armor. They want to buy a set and sell it later to a knight. Given the monthly prices, find the maximum profit.
