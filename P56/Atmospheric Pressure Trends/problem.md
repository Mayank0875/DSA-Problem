...
## Description
Meteorologists compare pressure readings from two different storms. They are looking for the longest continuous timeframe where the pressure fluctuations were identical in both storms. Determine the duration (length) of this matching weather pattern.
