...
You are in a reading marathon. You've recorded your progress for N pages. You mark '1' for a page you found interesting and '0' for a boring page. You want to find the longest "engaging segment" (contiguous pages) that contains at most `k` boring pages. What is this length?
