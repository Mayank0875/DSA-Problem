...
## Description
A wizard has `n` runes. Each rune has a power level. To cast the 'Ultimate Dispel', the wizard must channel a set of runes where the GCD of their power levels is 1.

Your task:
Count how many non-empty subsequences of runes have a greatest common divisor (GCD) of their power levels exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the power levels.
