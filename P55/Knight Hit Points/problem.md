...
## Description
In a RPG, a cleric's healing spell only targets knights with even Hit Points (HP). As knights take damage or heal, changing their HP, calculate the total HP of all knights currently targetable by the spell.
