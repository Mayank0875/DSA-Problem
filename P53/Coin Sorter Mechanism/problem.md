...
## Description
A coin sorting machine detects valid coins (values) and slugs (`0`). It mechanically diverts valid coins to the front of the rolling tube and pushes slugs to the end for rejection.
