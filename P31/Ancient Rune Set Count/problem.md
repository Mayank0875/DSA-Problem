...
You have found $N$ ancient runes, each with a power value $candidates_i$. Your collection of runes may include duplicates. To activate a portal, you must select a set of runes with a total power of exactly $T$. Your task is to find the *total count* of unique combinations of these runes that sum to $T$. Each rune stone may be used *only once*.
