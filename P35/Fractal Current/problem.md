...
In a mysterious fractal river, currents flow in identical rectangular patterns.  
There are **n** such current segments, each having a width of **w** units and a height of **h** units.  
To study them, researchers need to confine all the segments flat inside a single square basin.  
The segments cannot be rotated. Your task is to determine the smallest possible side length of a square basin that can hold all **n** segments without any overlap.
