...
## Description
Books are arranged in a grid on a display table. A secret code involves reading the titles of adjacent books in a specific order. Given the grid of book codes, check if the secret message can be found.
