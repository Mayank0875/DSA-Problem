...
## Description
A podcaster looks at the duration of their episodes in chronological order. For each episode, they calculate a 'duration streak': the number of consecutive previous episodes (including the current one) that were shorter or equal in length. Given the episode durations, calculate this streak.
