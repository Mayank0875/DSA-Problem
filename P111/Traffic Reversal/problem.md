...
## Description
During a city emergency, all lanes on a highway are switched to flow in the opposite direction (contraflow).

The data is stored as a string `s`. To update the traffic flow model, you must reverse the string.
