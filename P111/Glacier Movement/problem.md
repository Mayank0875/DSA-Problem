...
## Description
GPS markers track glacier speed daily. Glaciologists smooth the data to study seasonal flow rates.

You are given a **0-indexed** array `nums` of `n` integers representing speed measurements and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of speed measurements.
