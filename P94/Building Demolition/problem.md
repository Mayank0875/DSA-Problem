...
## Description
A building is demolished floor by floor. The charges remove floors equal to any digit in the current floor count.

The floor count currently has a value of $n$. To level the building, you must reduce this value exactly to $0$.
