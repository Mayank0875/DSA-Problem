...
## Description
An old magnetic audio tape was spooled incorrectly, causing the audio data to play backwards.

The data is stored as a string `s`. To restore the audio track, you must reverse the string.
