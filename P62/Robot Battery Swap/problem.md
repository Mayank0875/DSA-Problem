...
## Description
A station swaps k batteries. Batteries are by model ID. It swaps the rare models out of circulation first. Determine the minimum number of unique battery models left.
