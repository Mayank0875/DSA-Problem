...
## Description
An artist creates a floor mosaic. They want to verify if a hidden message (sequence of colored tiles) exists in the pattern. The message is formed by adjacent tiles. Determine if the message is hidden in the floor.
