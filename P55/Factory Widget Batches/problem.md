...
## Description
A factory produces widgets in batches. Batches with an even count are sent to quality control (QC). As production errors are fixed or items added, calculate the total number of widgets currently in the QC queue.
