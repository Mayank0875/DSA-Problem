...
## Description
A gardener is building a fence. Each section requires two planks placed vertically to reach a specific target height. Given a pile of cut wood planks, count how many pairs can be combined to reach the exact target height.
