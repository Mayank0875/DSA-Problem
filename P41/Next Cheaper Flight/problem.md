...
## Description
You are building a flight booking assistant that tracks ticket prices for a specific route over the next month. For any given day, the user wants to know the price on the soonest upcoming day that is strictly cheaper than today. This allows travelers to delay their trip slightly for savings. Given the list of daily flight prices, find the next lower price for each day. If there are no cheaper flights in the future, report that no such day exists.
