...
## Description
A security system logs threat IDs. Rare, anomalous threats should be flagged first. Sort the log so that the least frequent threat IDs appear at the top. If frequencies match, the higher threat ID takes precedence.
