...
## Description
Satellite sensors measure ground brightness. Astronomers average these values to create a contour map of light pollution.

You are given a **0-indexed** array `nums` of `n` integers representing brightness levels and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of brightness levels.
