...
## Description
A bartender pours liquids of different densities into a glass.

The liquids are represented as a string $S$.
However, the order of the layers is not fixed. Different pouring orders create different visual layers.

Your task is to calculate the **total number of distinct drinks** that can be formed using the characters of the string $S$. Since the number of possibilities can be very large, print the result modulo $10^9 + 7$.
