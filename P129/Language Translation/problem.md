...
## Description
A translator checks if the meaning of a sentence is preserved in a word-for-word translation stream.

You are given two strings `target` and `source` consisting of words.
