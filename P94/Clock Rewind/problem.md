...
## Description
A time wizard rewinds a clock. They can move hands back by minutes equal to any digit in the current minute reading.

The minute reading currently has a value of $n$. To reach zero hour, you must reduce this value exactly to $0$.
