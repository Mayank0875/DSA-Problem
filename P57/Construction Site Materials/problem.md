...
## Description
A foreman has a pile of raw materials (bricks, beams, etc.). There are blueprints for small structures. A structure can be built if the pile contains the necessary materials. Calculate the total material units of all buildable structures.
