...
## Description
A security protocol rotates keys. Even rotation slots use keys sorted by bit-strength ascending. Odd rotation slots use keys sorted by bit-strength descending. Given the key strengths, determine the rotation order.
