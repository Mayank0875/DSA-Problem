...
To enchant a sword, you need to provide exactly $T$ units of "soul essence". You have an infinite supply of soul gems of different sizes, which provide varying amounts of essence (e.g., 2, 3, 5). Your task is to find the *total number* of unique combinations of soul gems that will sum to $T$ essence.
