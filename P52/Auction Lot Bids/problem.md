...
## Description
An auctioneer lists items by starting bid. Rare items (fewest of their kind) are auctioned first. If the count of items is the same, the one with the higher starting bid goes first.
