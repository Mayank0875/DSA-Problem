...
## Description
An album view has photos (IDs) and deleted placeholders (`0`). The 'cleanup' button shifts all photos to the start of the album view, pushing the placeholders to the end.
