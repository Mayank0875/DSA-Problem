...
The Obsidian Key: Next Higher Inscription
...
An ancient order is studying the inscriptions on a series of obsidian tablets to uncover the secrets of the legendary Obsidian Key. For each tablet, they want to identify the inscription value of the nearest future tablet that bears a strictly higher number. This helps them trace the escalation of power or pinpoint pivotal moments in the key’s history. If no future tablet has a higher value (either because it is the last tablet or all subsequent tablets have lower or equal values), this should be noted. Can you calculate this for each tablet?
