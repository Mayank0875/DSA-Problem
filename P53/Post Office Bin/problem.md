...
## Description
A sorting bin contains parcels (non-zero weights) and air gaps (`0`). A piston pushes the parcels to one side to condense them for transport, ensuring all air gaps are moved to the far end of the bin.
