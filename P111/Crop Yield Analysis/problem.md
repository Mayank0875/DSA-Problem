...
## Description
A farmer analyzes yield per acre along a strip of land. Averaging the yield with neighboring acres helps identify soil quality zones.

You are given a **0-indexed** array `nums` of `n` integers representing yield amounts and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of yield amounts.
