...
## Description
A collector organizes puzzle boxes. Boxes with an even number of pieces are stored in the 'Standard' section. As pieces are lost or found, changing the counts, report the total number of pieces contained in the 'Standard' section boxes.
