...
## Description
A city has `n` traffic lights with different cycle durations. To prevent gridlock synchronization, engineers activate lights whose cycle times have a GCD of 1.

Your task:
Count how many non-empty subsequences of lights have a greatest common divisor (GCD) of their cycle durations exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the cycle durations.
