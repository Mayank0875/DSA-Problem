...
## Description
An energy storage facility buys electricity from the grid when cheap and sells it back when expensive. Given the hourly electricity rates, calculate the maximum profit from one charge-discharge cycle.
