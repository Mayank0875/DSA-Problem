...
## Description
A museum display arranges artifacts. Even display cases show items sorted by age ascending (youngest to oldest). Odd cases show items sorted by age descending (oldest to youngest). Given the ages of the artifacts, organize the display.
