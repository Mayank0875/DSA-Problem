...
## Description
A planner matches building heights. Floors can be added in integer blocks.

You have two lists of floor counts.

In a single addition, The planner can:
...
The planner wants to make the lists identical (i.e., $a_i = b_i$ for all $1 \le i \le n$) using the **minimum** number of additions.
