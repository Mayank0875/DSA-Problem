...
## Description
An alchemist brews potions with varying potency levels. A magical ritual draws power only from potions with an even potency value. As ingredients are added, changing the potency of specific potions, report the total available power from all even-potency potions.
