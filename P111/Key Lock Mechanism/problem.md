...
## Description
To unlock a safe, the tumblers must be turned left, then right. Resetting the lock involves reversing this sequence.

The data is stored as a string `s`. To reset the lock, you must reverse the string.
