...
## Description
HR reviews employee certifications by ID. Rare certifications (held by few people) are prioritized. If two certifications are held by the same number of people, the one with the higher ID is listed first.
