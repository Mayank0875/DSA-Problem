...
## Description
A farmer counts bushels of corn in different silos. Silos with an even number of bushels are sealed for winter. As corn is added or taken for feed, calculate the total bushels stored in sealed silos.
