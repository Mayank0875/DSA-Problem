...
## Description
In an automated factory, robotic arms move components. Each arm has two grippers (can hold max 2 items) and a maximum lifting weight. Given the weights of the components on the assembly line, calculate the minimum number of arm movements required.
