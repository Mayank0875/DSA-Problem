...
## Description
A zookeeper feeds animals. A meal consists of two food items. The total protein content of the pair must match the animal's dietary requirement. Given the protein values of food items, count the valid meal pairs.
