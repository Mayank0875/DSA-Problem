...
A miner is working on an N-meter-long asteroid belt. A '1' means a meter is rich in resources, and '0' means it is empty. The mining drill has a "durability" of `k`, meaning it can drill through at most `k` empty meters before needing to cool down. Find the length of the longest contiguous segment the miner can drill.
