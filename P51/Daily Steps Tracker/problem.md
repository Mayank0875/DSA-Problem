...
## Description
A pedometer app records daily step counts. Users want to see their 'activity spike streak' for each day, which is the number of consecutive days ending today where the step count was less than or equal to today's count. Given the history of step counts, determine this streak for every day.
