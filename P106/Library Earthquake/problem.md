...
## Description
An earthquake tilts the library. Books slide along shelves, hitting bookends.
...
The floor tilting causes the entire grid to **rotate 90 degrees clockwise**. Following this rotation, gravity takes effect, causing the books to fall downwards. Each book falls until it lands on a bookend, another book, or the bottom boundary of the grid.

**Crucial Rules:**
1.  Gravity does not affect bookends; they are anchored in place relative to the grid structure.
...
#### Explanation
The bookends hold their relative positions. books pile up on top of obstacles or the floor.
