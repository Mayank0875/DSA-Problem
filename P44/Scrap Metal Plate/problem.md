...
## Description
A welder has found a piece of scrap metal composed of fused metal bars of varying lengths. He needs to cut a single rectangular plate from this scrap piece for a repair job. Given the lengths of the bars, calculate the maximum area of the rectangular plate he can salvage.
