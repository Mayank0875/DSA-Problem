...
## Description
A solar farm optimizes output. Even rows of panels are sorted by wattage ascending. Odd rows are sorted by wattage descending. Given the wattage values, map the panels to the grid.
