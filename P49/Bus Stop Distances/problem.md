...
## Description
A bus route consists of stops located at specific distances from the depot, stored in a sorted list. A passenger wants to get off at a specific mile marker. The bus driver needs to identify the index of the first stop that is at or beyond the requested mile marker.
