...
## Description
A blacksmith has a pile of raw metal ores and gem shards (represented by characters). There is a list of blueprints for weapons and armor. Each blueprint requires specific materials. Calculate the total crafting value (sum of lengths) of all items that can be forged with the available materials.
