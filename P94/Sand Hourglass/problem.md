...
## Description
A magical hourglass flows based on its own sand count. You can speed it up by removing grains equal to any digit in the remaining count.

The sand grain count currently has a value of $n$. To empty the hourglass, you must reduce this value exactly to $0$.
