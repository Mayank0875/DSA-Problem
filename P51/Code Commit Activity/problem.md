...
## Description
A developer tracks the number of code commits made each day. For each day, they want to know the 'activity span': the number of consecutive days ending today where the number of commits was less than or equal to today's count. Given the daily commit logs, calculate this span for each day.
