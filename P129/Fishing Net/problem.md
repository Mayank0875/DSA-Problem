...
## Description
A fisherman checks the catch for a specific food chain sequence.

You are given two strings `target` and `source` consisting of fish types.
