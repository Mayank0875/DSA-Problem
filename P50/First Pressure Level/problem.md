...
## Description
A deep-sea sensor log records pressure levels sorted from low to high. A scientist wants to identify the first reading that hit a specific pressure benchmark. Given the sorted pressure readings, return the index of the first match.
