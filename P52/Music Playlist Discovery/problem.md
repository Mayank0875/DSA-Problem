...
## Description
A music app generates a playlist based on listening history. Song IDs played least often (discovery tracks) should be played first. If play counts are equal, the song with the higher ID (likely newer) plays first.
