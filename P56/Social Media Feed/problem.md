...
## Description
An algorithm compares the news feeds of two users (post IDs). It wants to find the longest continuous sequence of posts that appeared in the exact same order for both users. Determine the length of this shared feed segment.
