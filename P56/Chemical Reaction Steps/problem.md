...
## Description
Two chemical processes are logged as sequences of reaction state codes. A chemist looks for the longest continuous sequence of states that is shared, indicating a common reaction mechanism. Find the length of this mechanism.
