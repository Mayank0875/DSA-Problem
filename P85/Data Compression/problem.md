...
## Description
A compressor analyzes `n` file chunks with different byte counts. It groups chunks efficiently if their byte counts have a GCD of 1.

Your task:
Count how many non-empty subsequences of chunks have a greatest common divisor (GCD) of their byte counts exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the byte counts.
