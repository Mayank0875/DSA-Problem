...
## Description
Space miners target asteroids. A gravity tether only works on asteroids with an even mass value. As mining lasers chip away mass or debris is added, calculate the total mass of all asteroids that can currently be tethered.
