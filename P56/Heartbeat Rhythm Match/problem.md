...
## Description
Doctors compare the ECG intervals (integers) of a patient at rest versus during exercise. They look for the longest continuous sequence of intervals that remained consistent. Determine the number of beats in this stable sequence.
