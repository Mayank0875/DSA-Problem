...
## Description
A wall is dismantled. Workers remove bricks equal to any digit in the remaining brick count.

The brick count currently has a value of $n$. To remove the wall, you must reduce this value exactly to $0$.
