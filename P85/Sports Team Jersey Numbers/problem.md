...
## Description
A coach selects players for a starting lineup. The coach is superstitious and only fields a team if the GCD of their jersey numbers is 1.

Your task:
Count how many non-empty subsequences of players have a greatest common divisor (GCD) of their jersey numbers exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the jersey numbers.
