...
## Description
You are spending loyalty points. The store lets you redeem points equal to any digit in your current balance.

The point balance currently has a value of $n$. To use all points, you must reduce this value exactly to $0$.
