...
## Description
A zookeeper has a pantry of food items. They have diet plans for animals. A diet can be prepared if the pantry has all the foods. Calculate the total food item count of all preparable diets.
