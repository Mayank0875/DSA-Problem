...
## Description
Data packets arrive at a server. Due to a routing error, the bytes in the payload string are completely reversed.

The data is stored as a string `s`. To parse the payload, you must reverse the string.
