...
The function should efficiently determine whether the grimoire is present and return true if present otherwise false . The grimoire IDs are sorted in non-decreasing order.
