...
## Description
A biologist studies `n` bacterial strains, each with a genetic marker value. A diverse colony is formed if the selected strains have genetic markers with a combined GCD of 1.

Your task:
Count how many non-empty subsequences of strains have a greatest common divisor (GCD) of their genetic markers exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the genetic markers.
