...
## Description
A smart highway assigns speed limits to lanes. Even-indexed lanes are for accelerating traffic (speed limits sorted ascending). Odd-indexed lanes are for decelerating traffic (speed limits sorted descending). Given a list of speed limits, assign them to the lanes according to this rule.
