...
## Description
A version control system compares two versions of a source file (lines converted to hashes). It needs to highlight the longest continuous block of lines that remained unchanged. Find the number of lines in this block.
