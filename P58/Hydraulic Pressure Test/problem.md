...
## Description
A hydraulic system has multiple valves. Opening two valves results in a total pressure equal to the sum of their individual flows. Count the pairs of valves that produce a specific target pressure when opened together.
