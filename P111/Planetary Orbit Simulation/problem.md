...
## Description
To verify a past eclipse, scientists run the planetary motion simulation backwards from today.

The data is stored as a string `s`. To simulate the past, you must reverse the string.
