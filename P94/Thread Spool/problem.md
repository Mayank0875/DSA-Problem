...
## Description
A machine unwinds thread. It pulls meters equal to any digit in the remaining thread length.

The thread length currently has a value of $n$. To empty the spool, you must reduce this value exactly to $0$.
