...
## Description
A diver swims over a coral grid. They want to film a specific sequence of fish inhabiting the coral. They swim between adjacent coral heads. Check if the film sequence is possible.
