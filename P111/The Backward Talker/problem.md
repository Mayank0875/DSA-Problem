...
## Description
You meet a wizard who speaks in reverse. To understand his riddle, you must take his spoken words and flip them.

The data is stored as a string `s`. To solve the wizard's riddle, you must reverse the string.
