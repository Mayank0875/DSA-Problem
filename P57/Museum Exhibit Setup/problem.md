...
## Description
A curator has a storage of artifacts. They have themes for displays. A display can be set up if storage has all the artifacts. Calculate the total artifact count of all possible displays.
