...
## Description
A water park log flume ride has boats that seat up to two riders. For safety, the total weight in a boat cannot exceed a specific limit. Given the weights of the riders in line, find the minimum number of boats needed to send everyone down the flume.
