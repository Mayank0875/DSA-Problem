...
## Description
A horse-drawn carriage ride allows at most two passengers at a time due to seating, and there is a strict weight limit to protect the horses. Given the weights of the people waiting for a ride, find the minimum number of carriages needed.
