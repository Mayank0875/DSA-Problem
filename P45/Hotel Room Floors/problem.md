...
## Description
A hotel reservation system lists booked rooms by floor number (represented as integers). The management wants to know how many rooms are currently occupied on a specific floor.
