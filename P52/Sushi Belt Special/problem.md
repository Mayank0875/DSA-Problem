...
## Description
A sushi chef puts plates on the belt by price ID. Special dishes made in small quantities come first. If quantities are the same, the more expensive plate (higher ID) comes first.
