...
## Description
A skyscraper elevator visits random floors. The maintenance log tracks floors visited. The technician checks for the longest sequence of consecutive floors serviced.

Given an unsorted array of integers `floors` representing the floor numbers, return the length of the longest consecutive sequence of stops that can be logged as a service run.
