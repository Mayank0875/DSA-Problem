...
You are a cashier. A customer is owed $T$ cents in change. You have a list of available coin denominations (e.g., 2, 3, 5). Your task is to find the *total number* of unique combinations of these coins that sum exactly to the target $T$. You can use any coin denomination an unlimited number of times.
