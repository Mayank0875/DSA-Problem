...
## Description
A lab report lists the pH values of samples sorted from acidic to basic. A researcher needs to find the first sample that has a specific target pH value. Given the sorted pH values, return the index of the first occurrence.
