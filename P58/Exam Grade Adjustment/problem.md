...
## Description
A teacher is curving grades. They want to find pairs of students whose combined raw scores sum to a 'perfect score' equivalent. Given the list of raw scores, count the student pairs that achieve this sum.
