...
## Description
An analyst looks for a specific voting trend pattern in the ballot stream.

You are given two strings `target` and `source` consisting of vote types.
