...
## Description
A zoo is moving animals to a new enclosure. The transport cages are designed to hold at most two animals, provided their combined weight is within the cage's safety rating. Given the weights of the animals, find the minimum number of cages needed for the move.
