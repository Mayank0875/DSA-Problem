...
## Description
A currency exchange service offers better rates for larger amounts. The tier thresholds are stored in a sorted list. A customer wants to exchange a specific amount of money. The system needs to find the first tier threshold that is greater than or equal to the customer's amount to determine the applicable rate category.
