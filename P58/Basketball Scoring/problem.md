...
## Description
A statistician analyzes game scores. They want to find pairs of quarters (periods) where the combined score equaled a specific record number. Given the scores of various quarters, count the pairs that meet the record condition.
