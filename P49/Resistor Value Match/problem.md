...
## Description
An electrical engineer is building a circuit and needs a resistor of at least a certain resistance value. They have a drawer of standard resistors sorted by their ohm values. Find the index of the first resistor in the drawer that is greater than or equal to the required resistance.
