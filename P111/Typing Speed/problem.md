...
## Description
A typing test calculates WPM. To show a real-time graph, it averages the speed of characters typed in a rolling window.

You are given a **0-indexed** array `nums` of `n` integers representing speeds and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of speeds.
