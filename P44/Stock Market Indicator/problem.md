...
## Description
A financial analyst is looking at a bar chart of stock volumes over time. They want to draw a 'support box'—a rectangle that fits within the volume bars—to highlight a period of sustained trading activity. Calculate the maximum area of such a rectangle that fits within the volume histogram.
