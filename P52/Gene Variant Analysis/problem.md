...
## Description
Geneticists list gene variants by ID. Rare variants are of higher interest and should be listed first. If two variants appear with the same frequency, list the one with the higher ID first.
