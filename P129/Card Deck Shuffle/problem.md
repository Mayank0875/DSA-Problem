...
## Description
A magician counts the ways a specific hand can be dealt from a stacked deck.

You are given two strings `target` and `source` consisting of card ranks.
