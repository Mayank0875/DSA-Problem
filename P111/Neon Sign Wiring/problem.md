...
## Description
An electrician installed the wiring for a scrolling neon sign from right to left instead of left to right.

The data is stored as a string `s`. To fix the display message, you must reverse the string.
