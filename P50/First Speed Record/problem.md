...
## Description
A racing event logs car speeds sorted by velocity. A technician wants to verify the first car in the sorted logs that clocked a specific speed. Given the list of speeds, return the index of the first occurrence of the target speed.
