...
## Description
A recycling plant sorts materials by value code. Rare materials found in the batch are processed first. If counts are tied, the higher value material is processed first.
