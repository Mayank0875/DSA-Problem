...
## Description
A spectrum analyzer shows signal strength bars of varying heights across different frequencies. To filter noise, engineers need to identify the largest rectangular block of continuous signal energy. Calculate the maximum area of such a rectangle fitting under the signal bars.
