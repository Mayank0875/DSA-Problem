...
## Description
A starship computer has `n` navigation beacons. To calculate a safe hyperspace jump, the pilot must select beacons whose coordinate hashes have a collective GCD of 1.

Your task:
Count how many non-empty subsequences of beacons have a greatest common divisor (GCD) of their coordinate hashs exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the coordinate hashs.
