...
## Description
A reviewer tests phone usage. They want to find two apps whose combined battery drain percentage equals a specific benchmark. Given the drain stats of various apps, count the pairs that hit the benchmark exactly.
