...
## Description
A goblin steals gold. It grabs coins equal to any digit in the pile's current count.

The coin pile currently has a value of $n$. To steal all the gold, you must reduce this value exactly to $0$.
