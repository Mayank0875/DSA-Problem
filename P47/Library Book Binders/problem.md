...
## Description
A librarian is archiving old manuscripts into protective binders. Each binder can hold at most two manuscripts, provided their combined thickness (value) doesn't exceed the binder's spine width. Given the thickness values, find the minimum binders needed.
