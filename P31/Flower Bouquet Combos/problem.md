...
You are a florist with $N$ flowers in your shop, with "beauty values" $candidates_i$. You may have multiple flowers of the same value. A customer wants a bouquet with a total beauty value of exactly $T$. Your task is to find the *total count* of unique combinations of flowers that sum to $T$. Each flower in your shop may be used *only once*.
