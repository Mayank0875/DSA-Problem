...
## Description
Scientists classify meteorites by mass class. Rare mass classes found in the field are studied first. If the number of meteorites in two classes is the same, the heavier mass class is studied first.
