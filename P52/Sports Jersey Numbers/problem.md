...
## Description
A memorabilia shop organizes jerseys by player number. Rare numbers (fewest in stock) should be displayed in the front window. If stock counts are equal, the higher player number goes in front.
