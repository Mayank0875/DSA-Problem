...
## Description
On a highway, mile markers are placed. A surveyor looks for two markers such that the distance between them (or their sum relative to a reference) equals a target value. Count the pairs of markers satisfying the condition.
