...
## Description
A chess engine compares two game histories represented by move IDs. It wants to find the longest continuous sequence of moves that was played in both games to analyze opening theory trends. Calculate the number of moves in this sequence.
