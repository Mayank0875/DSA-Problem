...
## Description
Solar panels produce different voltages. To connect to an inverter, strings of two panels must sum to a specific input voltage. Count the number of panel pairs that meet the inverter's voltage requirement.
