...
A museum displays a historical timeline as an m x n grid of years. The years are organized as follows:
    1. Each row (era) is sorted by year.
    2. The first year in a new era is always greater than the last year in the previous era.

Given a target year, return 1 if it is on the timeline or 0 otherwise. 
