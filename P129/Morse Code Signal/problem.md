...
## Description
A radio operator counts interpretations of 'SOS' from a continuous stream of dots and dashes.

You are given two strings `target` and `source` consisting of dots and dashes.
...
- Strings consist of dots and dashes.
