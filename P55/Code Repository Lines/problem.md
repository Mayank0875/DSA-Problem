...
## Description
A software project tracks lines of code (LOC) in files. A linter checks only files with an even number of lines. As developers commit changes (adding/deleting lines), report the total LOC of all files currently being linted.
