...
You have a cookie jar with $N$ cookies, with calorie counts $candidates_i$. The jar might have multiple cookies with the same calorie count. You want to eat a snack with a total calorie count of exactly $T$. Your task is to find the *total count* of unique combinations of cookies from the jar that sum to $T$. Each cookie may be eaten *only once*.
