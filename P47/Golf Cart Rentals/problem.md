...
## Description
A golf course rents out carts. Each cart seats two golfers and has a weight limit for the battery engine. Given the weights of a group of golfers, calculate the minimum number of carts they need to rent.
