...
## Description
A space station is too heavy and must eject k cargo pods. Pods contain resources marked by Type ID. The commander wants to simplify the manifest by removing entire resource types. Find the minimum number of unique resource types remaining.
