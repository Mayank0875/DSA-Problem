...
## Description
A logger cuts down k trees in a sector. Trees are identified by species ID. The goal is to create a monoculture for easier processing. Determine the minimum number of unique tree species standing.
