...
## Description
A game shop has a box of spare tokens. They have a list of incomplete games. A game can be completed if the box has all the missing tokens. Calculate the total token count of all completable games.
