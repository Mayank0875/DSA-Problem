...
## Description
A puzzle involves a grid of marked squares. A piece must move to adjacent squares to spell out a solution word. Given the grid and the solution word, determine if the puzzle is solvable.
