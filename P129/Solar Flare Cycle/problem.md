...
## Description
Scientists analyze solar data for a specific intensity pattern.

You are given two strings `target` and `source` consisting of intensity levels.
...
- Strings consist of intensity levels.
