...
## Description
A bomb timer is ticking down. You can hack the timer to skip seconds. The hack allows you to reduce the time by any digit currently displayed on the countdown.

The timer currently has a value of $n$. To defuse the bomb, you must reduce this value exactly to $0$.
