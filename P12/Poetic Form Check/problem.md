...
You are studying a special poetic form where a line of text S is considered "perfect" if it is a palindrome. A palindrome is a string that reads the same forwards as it does backward. Given a line of text S, determine if it is perfect. Return 'Yes' or 'No'.
