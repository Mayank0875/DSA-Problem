...
## Description
A competition ranks participants by score. The judges are interested in scores that were achieved by exactly two participants, as this creates a specific type of tie. Given the list of all scores submitted, return the score values that appear exactly twice.
