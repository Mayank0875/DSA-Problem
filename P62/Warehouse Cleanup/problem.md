...
## Description
A logistics manager needs to clear space in a warehouse by shipping out exactly k crates. The crates contain different products identified by IDs. To simplify future inventory checks, the manager wants to eliminate as many distinct product categories as possible. Determine the minimum number of unique product IDs remaining after removing k crates.
