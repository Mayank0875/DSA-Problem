...
## Description
Astronomers are identifying binary star systems where the combined mass of the two stars equals a critical limit for supernova formation. Given the masses of observed stars, count the number of pairs that could potentially form such a critical system.
