...
## Description
A continuous monitor records BP. Doctors look at the centered average to diagnose hypertension without noise from movement.

You are given a **0-indexed** array `nums` of `n` integers representing pressure readings and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of pressure readings.
