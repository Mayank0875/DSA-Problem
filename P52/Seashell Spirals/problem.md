...
## Description
A beachcomber sorts shells by spiral count. Rare shells (found less often) are displayed first. If frequencies are equal, the shell with the higher spiral count is displayed first.
