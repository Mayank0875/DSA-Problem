...
## Description
A bartender has a shelf of spirits and mixers. They have a menu of cocktails. A cocktail can be mixed if the shelf has all the ingredients. Calculate the total ingredient count of all mixable drinks.
