...
## Description
A map generator creates jagged terrain heights. To make the landscape look natural, you need to average the height of each point with its neighbors.

You are given a **0-indexed** array `nums` of `n` integers representing terrain heights and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of terrain heights.
