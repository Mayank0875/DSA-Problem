...
## Description
A radio signal buffer has data spikes (non-zero) and static/nulls (`0`). The processor cleans the signal by moving all data spikes to the front of the time window, delaying the static to the end.
