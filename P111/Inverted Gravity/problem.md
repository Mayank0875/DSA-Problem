...
## Description
In a zero-G chamber, a text display is floating upside down and backward relative to your position.

The data is stored as a string `s`. To read the display, you must reverse the string.
