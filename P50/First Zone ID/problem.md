...
## Description
A city map divides areas into Zone IDs, listed in sorted order for a report. A planner wants to find the first entry for a specific Zone ID. Given the sorted list of Zone IDs, return the index of the first occurrence of the target ID.
