...
## Description
You are monitoring a grid of energy crystals in a power plant. Each crystal has a charge level. The system is most stable when utilizing crystals with an even charge level. Throughout the day, fluctuations add or subtract charge from specific crystals. After each fluctuation, you must calculate the total charge of all 'stable' (even-charged) crystals.
