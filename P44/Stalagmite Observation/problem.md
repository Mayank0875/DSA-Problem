...
## Description
In a cave, stalagmites rise from the floor to various heights. Researchers want to set up a rectangular observation screen behind a row of stalagmites. The screen must be fully obscured by the rocks to not disturb cave life. Calculate the maximum area of the screen that can be hidden behind the stalagmite profile.
