...
## Description
A phone monitors power drain. To estimate remaining battery life, it averages the discharge rate over recent usage.

You are given a **0-indexed** array `nums` of `n` integers representing discharge rates and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of discharge rates.
