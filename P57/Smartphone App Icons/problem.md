...
## Description
A designer has a folder of graphic assets. They have layouts for app interfaces. An interface can be mocked up if the folder has all the icons. Calculate the total asset count of all mockable interfaces.
