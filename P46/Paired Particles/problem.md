...
## Description
In a quantum physics simulation, particle IDs are detected. Entangled pairs result in the same particle type ID being detected exactly twice in the chamber. The physicist needs to isolate these entangled types. Given the detection log, return the IDs appearing exactly twice.
