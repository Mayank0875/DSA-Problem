...
## Description
A maglev train brakes. The magnetic brakes reduce speed by m/s equal to any digit in the current speed.

The speed currently has a value of $n$. To halt the train, you must reduce this value exactly to $0$.
