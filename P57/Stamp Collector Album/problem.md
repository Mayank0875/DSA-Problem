...
## Description
A collector has a box of loose stamps. They have pages for different countries. A page can be completed if the box has all the specific stamps. Calculate the total stamp count of all completable pages.
