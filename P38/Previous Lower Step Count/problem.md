...
## Description
You are building a fitness tracker app and analyzing a user's daily step counts. The user wants to know, for each day, the step count of the nearest previous day where they walked strictly fewer steps. This helps the user feel good about their current activity levels compared to their recent history. For each day's step count in the sequence, your goal is to find the value of the closest preceding day that was strictly smaller. If all previous days had higher or equal step counts, you should report that no such day exists. Your task is to compute this value for every day in the user's history.
