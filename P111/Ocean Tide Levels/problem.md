...
## Description
Tide gauges measure sea level. Scientists smooth the data to remove wave noise and track the underlying tidal cycle.

You are given a **0-indexed** array `nums` of `n` integers representing sea levels and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of sea levels.
