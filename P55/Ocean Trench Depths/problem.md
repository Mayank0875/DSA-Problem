...
## Description
Sonar maps ocean depths at various points. A submarine safety protocol sums the depths of points with an even depth measurement. As the map is refined with new data updates, recalculate this safety sum.
