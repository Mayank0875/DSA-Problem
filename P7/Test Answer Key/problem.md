...
You are grading an N-question true/false test. The correct answers are in array A (0=False, 1=True). You are given Q queries to score different sections. Each query (L, R, Val) asks you to count how many questions in the range [L, R] have the correct answer `Val`. To finalize the grades, you need to calculate the XOR sum of all query results.
