...
## Description
A community artist wants to paint a rectangular mural on a wooden fence. The fence is made of adjacent vertical planks of varying heights. The mural must be a single rectangle painted directly onto the wood. The height of the mural in any section cannot exceed the height of the shortest plank in that section. Calculate the maximum possible area of the mural.
