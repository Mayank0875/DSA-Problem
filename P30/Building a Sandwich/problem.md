...
You are making a sandwich and want to hit exactly $T$ "flavor points". You have $N$ ingredients, each with a point value (e.g., 2, 3, 5). You can use an unlimited amount of each ingredient. Your task is to find the *total number* of unique combinations of ingredients that will sum exactly to the target $T$.
