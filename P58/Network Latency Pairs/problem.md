...
## Description
A network engineer analyzes ping times. They look for two server hops whose combined latency equals the maximum allowed threshold. Count the pairs of hops that hit this limit.
