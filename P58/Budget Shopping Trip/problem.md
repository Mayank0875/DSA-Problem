...
## Description
A shopper has a list of item prices in a store. They have a gift card with a precise value and want to use it up completely by buying exactly two distinct items. Given the prices of all items on the shelf, count how many different pairs of items sum up exactly to the gift card's value.
