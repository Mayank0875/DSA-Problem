...
## Description
On a silicon die, logic gates are arranged in a grid. An engineer wants to verify if a critical timing path (a sequence of gate types) exists. The signal propagates to adjacent gates. Determine if the specified logic path is present on the chip.
