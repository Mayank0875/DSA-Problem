...
## Description
A drone is stuck at high altitude. Its descent protocol allows it to drop by meters equal to any digit in its current altitude reading.

The drone altitude currently has a value of $n$. To land the drone, you must reduce this value exactly to $0$.
