...
## Description
Engineers are planning to blast a rectangular tunnel through a mountain ridge. The ridge's cross-section is modeled as a series of columns of varying rock height. The tunnel entrance must be rectangular. Calculate the maximum cross-sectional area of the tunnel entrance that fits within the mountain's profile.
