...
## Description
You are writing a compiler for a new programming language. The parser needs to verify that all code blocks, array definitions, and function calls are properly nested.
