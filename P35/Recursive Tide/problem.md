...
The tide is coming in and the shoreline crew must arrange n identical rectangular driftwood planks on the sand.  
Each plank is w units wide and h units long. To keep the beach tidy, they need to place all planks flat inside a single square tide‑pool area.  
The planks cannot be rotated. Your task is to help the crew determine the side length of the smallest possible square tide‑pool that can hold all n planks without any overlap.
