...
## Description
A botanist plants flowers identified by species ID. Rare species (fewest seeds) should be planted in the primary bed. If seed counts are equal, the species with the higher ID is planted first.
