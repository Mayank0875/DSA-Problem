...
## Description
A blockchain network has `n` validator nodes with specific stake values. A consensus round is valid if the participating validators have stake values with a GCD of 1.

Your task:
Count how many non-empty subsequences of nodes have a greatest common divisor (GCD) of their stake values exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the stake values.
