...
## Description
In the Metaverse, the price of a digital land parcel changes daily. A speculator wants to buy a plot and sell it later. Given the daily price history, calculate the maximum profit.
