...
## Description
A grocery store tracks the remaining shelf life (in days) of batches of product arriving. For each batch, they want to identify the shelf life of the nearest future batch that has strictly fewer days remaining. This helps in prioritizing sales. Given the sequence of shelf life values, find the next lower value for each batch. If future batches all have equal or longer shelf lives, report -1.
