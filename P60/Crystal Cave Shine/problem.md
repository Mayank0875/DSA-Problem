...
## Description
Geologists catalog crystals. Even catalog entries are sorted by luminosity ascending. Odd entries are sorted by luminosity descending. Given the luminosity values, compile the catalog.
