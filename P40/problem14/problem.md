...
Next Higher Neuron Activation in a Neural Maze

## Slug

next-higher-neuron-activation
...
A researcher is studying the activation levels of neurons as they propagate through a simulated neural maze. For each neuron at a given step, they want to identify the activation value of the nearest future step where the activation is strictly higher. This helps understand the growth patterns of signal strength within the maze or pinpoint critical spikes. If no future step has a higher activation (either because it is the last step or all subsequent steps have lower or equal activation), this should be noted. Can you calculate this for each step?
