...
## Description
A missile closes in. Its guidance system reduces distance by meters equal to any digit in the current range finder.

The distance currently has a value of $n$. To hit the target, you must reduce this value exactly to $0$.
