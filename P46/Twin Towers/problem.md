...
## Description
An architect is reviewing building heights in a city model. They are looking for aesthetic symmetry and want to find height values that are used by exactly two buildings in the skyline. Given the list of building heights, return the heights that appear exactly twice.
