...
## Description
A gardener identifies weeds by type ID. They have the energy to pull out exactly k weeds today. To make the garden look uniform, they want to completely eradicate as many weed species as possible. Calculate the minimum number of unique weed types surviving.
