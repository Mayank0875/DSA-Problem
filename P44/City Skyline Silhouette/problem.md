...
## Description
A photographer wants to crop a photo of a city skyline to include only the buildings, removing the sky. The crop must be a rectangle. Given the heights of the adjacent buildings, determine the maximum area of the rectangular crop that consists entirely of building structures.
