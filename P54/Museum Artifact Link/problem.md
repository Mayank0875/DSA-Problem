...
## Description
A curator arranges artifacts in a grid. A tour guide wants to create a thematic tour following a specific sequence of eras. The tour moves between adjacent exhibits. Check if the tour route is possible.
