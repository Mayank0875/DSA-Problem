...
## Description
A hobbyist has a box of track pieces. They have diagrams for layouts. A layout can be built if the box has all the pieces. Calculate the total piece count of all buildable layouts.
