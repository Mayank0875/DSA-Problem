...
Celestial Circuit: Packing Starship Modules
...
The crew of the interstellar carrier is loading identical rectangular starship modules into a cargo bay.  
Each module is **w** units wide and **h** units long. All modules must be placed flat inside a single square cargo bay, and they cannot be rotated.  
Determine the smallest possible side length of the square cargo bay that can accommodate all **n** modules without any overlap.
