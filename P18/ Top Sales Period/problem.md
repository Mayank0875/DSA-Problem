...
You are an analyst at a retail company. You are given `n` days of sales data, the `Sales Record`. You need to find the `maximum total sales from any contiguous 'k'-day period` to report the best-performing streak to your manager.
