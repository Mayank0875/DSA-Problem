...
## Description
An astronomer lists the diameters of newly discovered planets in order of discovery. For each planet, they calculate a 'size span': the number of consecutive previously discovered planets (including the current one) that were smaller or equal in diameter. Given the list of diameters, calculate this span.
