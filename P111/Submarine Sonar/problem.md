...
## Description
Sonar pings return data. A specific echo effect reverses the frequency signature of the return ping.

The data is stored as a string `s`. To identify the signature, you must reverse the string.
