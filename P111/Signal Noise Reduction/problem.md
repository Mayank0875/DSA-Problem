...
## Description
The Communication Center receives a noisy signal. To analyze the data, you must smooth the signal by calculating local averages around each data point.

You are given a **0-indexed** array `nums` of `n` integers representing signal intensities and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of signal intensities.
