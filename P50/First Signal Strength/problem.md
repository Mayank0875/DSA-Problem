...
## Description
A wifi analyzer lists signal strengths sorted from weak to strong. A technician wants to find the first access point with a specific signal strength. Given the sorted signal values, find the index of the first occurrence of the target strength.
