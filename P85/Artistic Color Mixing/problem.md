...
## Description
A painter has `n` pigment tubes, each with a specific pigment code. A 'Master Blend' is created by mixing pigments whose codes have a GCD of 1.

Your task:
Count how many non-empty subsequences of pigments have a greatest common divisor (GCD) of their codes exactly equal to 1.
...
## Input Format
- The first line contains an integer n (the number of pigments).
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the codes.
