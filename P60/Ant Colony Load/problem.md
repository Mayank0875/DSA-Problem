...
## Description
Ants march in a line. Even ants carry loads sorted by weight ascending. Odd ants carry loads sorted by weight descending. Given the load weights, order the ants.
