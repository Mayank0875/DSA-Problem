...
## Description
A prototype battery needs to be fully discharged for recycling. The discharge controller allows reducing the charge by an amount equal to any digit shown on its display.

The battery charge currently has a value of $n$. To safely recycle it, you must reduce this value exactly to $0$.
