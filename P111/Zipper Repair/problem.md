...
## Description
A zipper is stuck. To fix it, you must move the slider in the exact opposite direction of how it got stuck.

The data is stored as a string `s`. To unstick the zipper, you must reverse the string.
