...
## Description
A baker places decorative toppers on a line of cupcakes.

The toppers are represented as a string $S$.
However, the order of the toppers is not fixed. The arrangement of toppers creates the display theme.

Your task is to calculate the **total number of distinct displays** that can be formed using the characters of the string $S$. Since the number of possibilities can be very large, print the result modulo $10^9 + 7$.
