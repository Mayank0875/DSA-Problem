...
A guild of shadow weavers is studying the intensity of colors in their past shadow spectrum recordings to plan their next illumination ritual. For each recorded shade, they want to identify the intensity value of the nearest future recording that had a strictly higher intensity. This helps them understand the evolution of the spectrum or spot particularly radiant moments. If no future recording had a higher intensity (either because it was the last recording or all subsequent recordings had lower or equal intensity), this should be noted. Can you calculate this for each recording?
