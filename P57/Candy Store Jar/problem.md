...
## Description
A shopkeeper has a jar of mixed candies. They have gift bag templates. A gift bag can be filled if the jar has all the specific candies. Calculate the total candy count of all fillable bags.
