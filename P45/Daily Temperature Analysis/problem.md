...
## Description
A climatologist has a historical record of daily high temperatures for a region, sorted chronologically by value (not by date) for statistical analysis. They need to determine how many days in the record hit a specific peak temperature.
