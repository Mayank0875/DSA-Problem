...
## Description
A sensor counts how many complete product kits pass by on the belt.

You are given two strings `target` and `source` consisting of part IDs.
