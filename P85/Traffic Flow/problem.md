...
## Description
A traffic engineer studies `n` roads with different speed limits. A 'Free Flow' zone is designated for a set of roads where the speed limits have a GCD of 1.

Your task:
Count how many non-empty subsequences of roads have a greatest common divisor (GCD) of their speed limits exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the speed limits.
