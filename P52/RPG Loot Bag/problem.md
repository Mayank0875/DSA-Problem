...
## Description
An adventurer is sorting the loot in their backpack. Items are represented by their item level. The adventurer wants to see unique or rare items first. Sort the items such that those with the lowest quantity appear at the top. For items with the same quantity, prioritize the ones with the higher item level.
