...
## Description
A robot has entered a dead-end tunnel. To exit safely, it must reverse its log of movement commands to retrace its steps exactly.

The data is stored as a string `s`. To navigate the robot out, you must reverse the string.
