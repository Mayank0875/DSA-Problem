...
## Description
A traveler has a closet of items. They have packing lists for different trips. A trip can be packed for if the closet has all the items. Calculate the total item count of all packable trips.
