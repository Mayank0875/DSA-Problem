...
## Description
An alliance is formed by $n$ delegates. There are 5 races with a strict ceremonial precedence order. The delegates line up in non-decreasing order of precedence. How many alliance lineups are possible?
