...
## Description
A player organizes cards by power rating. Cards that are unique in the hand (frequency 1) should be played first. If multiple cards have the same frequency, play the one with the higher power rating first.
