...
## Description
The cost of advanced servo motors changes based on availability. A roboticist wants to buy servos and resell them later. Given the daily prices, find the maximum profit.
