...
A new robot is being tested. It can only land on platforms whose identification numbers are perfect squares. The robot is facing a hallway with platforms numbered L to R. How many platforms can it land on?
