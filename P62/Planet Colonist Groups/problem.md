...
## Description
A colony ship wakes up k fewer colonists than planned. Colonists are by specialization ID. The computer minimizes complexity by not waking up small groups. Calculate the minimum number of unique specializations active.
