...
## Description
A print server logs document IDs. For a specific audit, the IT department wants to track documents that were printed on both sides of a sheet separately, appearing as exactly two jobs in the queue. Given the stream of document IDs, identify which documents were processed exactly twice.
