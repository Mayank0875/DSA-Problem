...
## Description
A grandmaster analyzes a game log to see how many variations led to a specific pawn structure.

You are given two strings `target` and `source` consisting of chess notation.
...
- Strings consist of chess notation.
