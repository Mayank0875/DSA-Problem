...
## Description
A wizard is draining a mana crystal. The spell consumes mana equal to any digit in the crystal's current energy level.

The mana level currently has a value of $n$. To empty the crystal, you must reduce this value exactly to $0$.
