...
## Description
A marketing firm has a sorted list of customer zip codes. To target a specific neighborhood campaign, they need to count the number of customers residing in a specific zip code area.
