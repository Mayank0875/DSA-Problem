...
## Description
A wind farm logs wind speeds every ten minutes. To predict power output dips, you need to find the wind speed of the nearest future reading that is strictly lower than the current one. Given the sequence of wind speed measurements, find the next lower value for each reading. If wind speeds remain high or increase, output -1.
