...
## Description
An image filter processes pixels. It looks for pairs of pixels in a row whose combined brightness value equals a threshold. Given the pixel values, count the number of such pairs.
