...
A neuroscientist is analyzing a sequence of neural spike amplitudes recorded over time to understand signal propagation. For each recorded spike, they want to identify the amplitude of the nearest future spike that has a strictly higher amplitude. This helps them study the escalation of neural activity or detect significant events. If no future spike has a higher amplitude (either because it is the last recording or all subsequent spikes have lower or equal amplitude), this should be noted. Can you calculate this for each spike?
