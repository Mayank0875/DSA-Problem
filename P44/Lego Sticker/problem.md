...
## Description
A child has built a wall using stacks of Lego bricks. The stacks are of different heights. They want to place a large rectangular sticker across the front of the wall. The sticker cannot hang in the air. Find the maximum area of the sticker that can be placed on the Lego wall.
