...
## Description
An SEO analyst looks at daily visitor counts. For each day, they calculate the 'growth streak', which is the number of consecutive days immediately preceding (and including) the current day where the visitor count was less than or equal to today's count. Given the array of daily visits, determine the growth streak for each day.
