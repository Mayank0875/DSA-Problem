...
## Description
A satellite transmits k data packets and clears buffer. Packets are by sensor ID. It prioritizes clearing buffers with little data. Find the minimum number of unique sensors with data left.
