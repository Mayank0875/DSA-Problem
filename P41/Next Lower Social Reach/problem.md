...
## Description
A marketing agency tracks the 'reach' (number of views) of consecutive posts. For each post, they want to find the reach of the nearest future post that performed strictly worse (lower reach). Given the list of reach numbers, find the next lower value for each post. If all future posts performed better or equally well, report -1.
