...
## Description
A shopper checks a receipt to see if they bought the ingredients for a recipe in order.

You are given two strings `target` and `source` consisting of item codes.
