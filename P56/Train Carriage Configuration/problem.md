...
## Description
Two trains are assembled with carriages of different types (IDs). A yard master looks for the longest continuous section of carriages that is identical in both trains. Calculate the length of this matching train section.
