...
## Description
In a variant of the Snake game, eating a special apple reverses the snake's body, making the tail the new head.

The data is stored as a string `s`. To reorient the snake, you must reverse the string.
