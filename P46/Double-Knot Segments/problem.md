...
## Description
A rope manufacturing machine ties knots and logs the segment ID. A 'Double Knot' is formed when the machine processes the same segment ID exactly twice. The quality control system needs to identify which segments received a double knot. Return the sorted list of these segment IDs.
