...
## Description
A traveler monitors the exchange rate of a foreign currency against the dollar. They want to convert dollars to foreign currency (buy) and convert back (sell) later to make a profit. Given the daily rates, find the best outcome.
