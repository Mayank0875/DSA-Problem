...
## Description
You have a fragment of a map of the Lost City, represented as a grid of district codes. You are looking for a specific route described in a journal. The route consists of a sequence of districts that must be visited in order, moving between adjacent districts. Check if this route exists on the map.
