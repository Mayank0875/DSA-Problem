...
## Description
A wind farm control system displays data. Even turbines are sorted by rotation speed ascending. Odd turbines are sorted by rotation speed descending. Given the speeds, update the display.
