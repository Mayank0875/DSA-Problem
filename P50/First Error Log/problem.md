...
## Description
A system log contains error codes sorted numerically. A developer is troubleshooting a specific error code and wants to find the first record of it in the sorted dump to trace the origin. Given the list of error codes, return the index of the first occurrence of the target code.
