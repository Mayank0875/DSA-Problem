...
## Description
Explorers trade navigational star maps. The value of a sector map changes as routes are verified. You want to buy a map and sell it later. Given the monthly prices, determine the maximum profit.
