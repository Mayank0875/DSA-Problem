...
## Description
An admiral commands `n` ships with different ID codes. A tactical squadron is formed by ships whose IDs have a GCD of 1.

Your task:
Count how many non-empty subsequences of ships have a greatest common divisor (GCD) of their ID codes exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the ID codes.
