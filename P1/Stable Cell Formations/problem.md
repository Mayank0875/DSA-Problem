...
In a biology lab, cell clusters are only stable if they contain a perfect square number of cells. A scientist observes samples with cell counts ranging from L to R. How many stable cluster sizes are in this range?
