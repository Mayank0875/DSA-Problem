...
## Description
A circle of `n` stones stands in a field, each with a magical resonance. The ritual succeeds if the chosen stones have resonances with a GCD of 1.

Your task:
Count how many non-empty subsequences of stones have a greatest common divisor (GCD) of their resonances exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the resonances.
