...
## Description
A grid of mirrors and crystals is set up. A laser beam must pass through a specific sequence of optical elements. The beam travels between adjacent grid cells. Check if the optical setup supports the required beam path.
