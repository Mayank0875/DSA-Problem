...
## Description
A jigsaw puzzle edge has a specific length. You have a pile of pieces. Two pieces fit together to form the edge if their combined length matches the border. Count the number of piece pairs that can form the border.
