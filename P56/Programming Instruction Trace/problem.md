...
## Description
A debugger compares the execution traces of two processes (instruction opcodes). It looks for the longest continuous sequence of instructions executed identically by both. Calculate the length of this shared execution path.
