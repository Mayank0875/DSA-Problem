...
## Description
A cargo train is coupled. Even wagons are sorted by load capacity ascending. Odd wagons are sorted by load capacity descending. Given the capacity values, assemble the train.
