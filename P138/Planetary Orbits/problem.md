...
## Description
A planet $x$ affects moon $y$. Orbit is stable if the gravitational vector (XOR) divides the mass of either body.

The simulation defines a specific relationship between a fixed integer $x$ and a candidate integer $y$. A value $y$ is considered "**stable**" with $x$ if:
