...
## Description
A robotic arm has two segments. The total reach is the sum of the segment lengths. To reach a specific coordinate, the sum must match the distance exactly. Count the valid segment pairs from the parts bin.
