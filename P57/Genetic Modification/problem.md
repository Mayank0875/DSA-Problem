...
## Description
A bio-engineer has a pool of gene sequences. They have a list of desired traits. A trait can be activated if the pool contains the specific gene markers. Calculate the total marker count of all activatable traits.
