...
## Description
A router manages a packet queue. Even positions in the queue are for standard traffic, sorted by priority ascending. Odd positions are for urgent traffic, sorted by priority descending. Given the packet priorities, output the queue structure.
