...
## Description
A meteorologist collects `n` temperature readings. A specific climate pattern is identified by a set of readings whose values have a GCD of 1.

Your task:
Count how many non-empty subsequences of readings have a greatest common divisor (GCD) of their temperatures exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the temperatures.
