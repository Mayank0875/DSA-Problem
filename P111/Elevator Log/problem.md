...
## Description
An elevator records the floors it visits going up. To return to the lobby efficiently, it calculates the reverse route.

The data is stored as a string `s`. To program the return trip, you must reverse the string.
