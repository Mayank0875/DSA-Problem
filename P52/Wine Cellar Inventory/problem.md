...
## Description
A sommelier organizes wines by vintage year. Rare vintages (few bottles left) should be moved to the reserve list first. If bottle counts are the same, the later vintage (higher year) is listed first.
