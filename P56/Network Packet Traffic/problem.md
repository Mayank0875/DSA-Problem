...
## Description
A network admin compares packet size logs from two different ports. To identify a specific file transfer, they look for the longest continuous sequence of packet sizes that appears in both logs. Determine the length of this packet stream.
