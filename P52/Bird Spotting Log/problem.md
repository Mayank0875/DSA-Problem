...
## Description
A birdwatcher logs bird species by their ID code. They want to generate a report where rare sightings (low frequency) appear at the top. If two species were spotted the same number of times, the species with the higher ID code should be listed first.
