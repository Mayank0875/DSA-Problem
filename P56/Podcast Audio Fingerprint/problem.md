...
## Description
A copyright bot scans two podcasts represented by audio fingerprints (integers). It looks for the longest continuous segment of matching audio to detect unauthorized clips. Find the length of the matching clip.
