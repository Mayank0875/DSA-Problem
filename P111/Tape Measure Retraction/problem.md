...
## Description
A digital tape measure stores measurements. When retracting, the data points enter the buffer in reverse order.

The data is stored as a string `s`. To normalize the measurement log, you must reverse the string.
