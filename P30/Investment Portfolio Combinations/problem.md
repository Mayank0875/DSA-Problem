...
You are a financial analyst. A client wants to invest a total of $T$ dollars. You have a list of available stocks with different share prices (e.g., 2, 3, 5). Your task is to find the *total number* of unique combinations of shares that sum exactly to the target investment $T$. You can buy an unlimited number of shares of each stock.
