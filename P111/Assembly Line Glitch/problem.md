...
## Description
A manufacturing arm has malfunctioned and assembled a product code sequence from tail to head.

The data is stored as a string `s`. To correct the product code, you must reverse the string.
