...
## Description
Two delivery trucks have GPS logs represented by a sequence of road segment IDs. The logistics manager wants to know the longest continuous path where both trucks traveled the exact same road segments in the same order. Determine the length of this shared route.
