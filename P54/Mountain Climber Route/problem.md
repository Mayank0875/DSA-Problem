...
## Description
A mountain face is mapped as a grid of holds, each rated by difficulty grade (letter). A climber plans a route represented by a string of grades. They can only move to adjacent holds. Determine if the planned route exists on the mountain face.
