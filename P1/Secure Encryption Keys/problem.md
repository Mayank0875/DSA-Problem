...
A new encryption system uses numerical keys. A key is considered "secure" only if it's a perfect square. Given a range of keys from L to R, determine how many are secure.
