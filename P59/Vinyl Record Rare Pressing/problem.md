...
## Description
A rare vinyl pressing's value changes based on collector demand. An audiophile wants to buy it and sell it later. Given the monthly Discogs median price, calculate the maximum profit.
