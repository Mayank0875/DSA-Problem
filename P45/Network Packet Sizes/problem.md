...
## Description
A firewall logs the size of every incoming packet, sorted for traffic analysis. To detect a specific type of attack, the security admin needs to count the number of packets that match a suspicious size.
