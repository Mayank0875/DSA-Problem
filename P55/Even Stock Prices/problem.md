...
## Description
A specialized trading algorithm only buys stocks that are trading at an even dollar price. As the market ticks and prices change, calculate the sum of the prices of all stocks that the algorithm would currently consider buying.
