...
## Description
A decontamination unit lowers radiation levels. Each cycle removes rads equal to any digit in the current radiation reading.

The radiation level currently has a value of $n$. To decontaminate the area, you must reduce this value exactly to $0$.
