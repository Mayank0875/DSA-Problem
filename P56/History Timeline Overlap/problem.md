...
## Description
Two ancient civilizations have historical records represented by event codes. Historians want to find the longest continuous period where the recorded events match exactly, suggesting a period of shared history or contact. Find the length of this matching era.
