...
## Description
There are `n` satellites in orbit with different orbital periods. To establish a global uplink, ground control must link satellites whose periods have a GCD of 1.

Your task:
Count how many non-empty subsequences of satellites have a greatest common divisor (GCD) of their orbital periods exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the orbital periods.
