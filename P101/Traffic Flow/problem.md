...
## Description
A traffic camera records car colors `s`. Cars exit the highway at random. The traffic controller counts how many unique sequences of car colors can arrive at the next city.
