...
## Description
A wizard's spellbook contains a grid of runes. To cast a spell, one must trace a continuous line through adjacent runes that matches the spell's incantation. Given the rune grid and the incantation, determine if the spell can be cast.
