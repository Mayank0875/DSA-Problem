...
## Description
A lab array fires lasers. Even emitters are sorted by intensity ascending. Odd emitters are sorted by intensity descending. Given the intensities, configure the array.
