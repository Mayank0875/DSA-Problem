...
## Description
A police department reviews traffic violation codes. Rare types of violations should be highlighted at the top of the report. If two violation types occur with the same frequency, list the one with the higher code value first.
