...
## Description
Paleontologists sort bone fragments by size ID. Rare bone types found at the site are cataloged first. If counts are tied, the larger size ID is cataloged first.
