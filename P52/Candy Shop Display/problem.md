...
## Description
A candy shop arranges sweets by flavor ID. Limited edition flavors (low stock) go to the front. If stock levels are equal, the flavor with the higher ID is placed first.
