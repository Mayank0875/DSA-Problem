...
## Description
A geologist looks for a specific tremor pattern in a continuous seismic graph.

You are given two strings `target` and `source` consisting of reading values.
...
- Strings consist of reading values.
