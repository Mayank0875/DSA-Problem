...
## Description
A logistics company logs delivery distances sorted by length. A manager needs to find the first delivery that covered exactly a specific target distance. Given the sorted list of distances, return the index of the first occurrence.
