...
In the endless tapestry of the cosmos, a civilization records the intensity of resonant echoes across time. For each recorded echo, they seek the intensity of the nearest future echo that is strictly stronger. This reveals the pattern of growing cosmic vibrations or highlights singular powerful bursts. If there is no later echo with a higher intensity (either because it is the final record or all subsequent echoes are weaker or equal), this must be indicated. Determine this value for every recorded echo.
