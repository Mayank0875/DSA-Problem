...
An N-hour log of a city's power grid is given. '1' indicates a stable hour of full power, and '0' indicates a 'brownout' hour. The grid is considered "reliable" if any continuous time window contains at most `k` brownout hours. Find the length of the longest reliable period recorded in the log.
