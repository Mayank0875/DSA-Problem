...
## Description
A mechanic uses k nuts and bolts for a project. Parts are by size ID. They want to empty out the compartments with few items. Find the minimum number of unique part sizes remaining in the bin.
