...
## Description
A store manager is reviewing inventory. Items are listed by ID. To identify stock issues, items with the lowest quantity on the shelf should be listed first. If two items have the same stock count, the one with the higher ID (usually newer or more expensive) should come first.
