...
## Description
A city traffic grid has sensors recording congestion levels. A driver claims to have taken a route with a specific congestion profile. They drove between adjacent blocks. Verify if such a route profile exists.
