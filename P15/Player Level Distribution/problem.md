...
## Description
You are analyzing N players in an online game. Player levels range from 0 to 100. Given a list of all player levels, find the number of players at the most common level. In other words, find the highest frequency among all levels and print that number.
