...
## Description
A sci-fi simulation generates universe IDs. Stable wormholes connect exactly two universes, recording the wormhole ID twice (once for each end). Unstable ones appear once or many times. The navigator needs the IDs of stable wormholes. Find IDs appearing exactly twice.
