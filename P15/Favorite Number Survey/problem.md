...
## Description
A survey asks N people for their favorite number (between 0 and 100). Given the list of N responses, find out how many people chose the most popular number. In other words, find the highest frequency among all chosen numbers and print that number.
