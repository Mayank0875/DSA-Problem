...
## Description
A firewall filters packets by checking for a malicious byte sequence within the payload.

You are given two strings `target` and `source` consisting of hex bytes.
