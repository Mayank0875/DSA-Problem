...
You need to pay for an item that costs *exactly* `sum`. You have `n` different coins and bills in your wallet. You must determine if you can use a subset of your `n` items of currency to pay the exact amount. You cannot break a bill or coin, and you can use each one only once.
## Examples
