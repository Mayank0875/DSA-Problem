...
## Description
A worker lays ties. They place 1 tie or a pre-assembled pair.

The worker starts at meter 0 and wishes to reach meter $n$. On each move, The worker can lay forward either **1 meter** or **2 meters**.
