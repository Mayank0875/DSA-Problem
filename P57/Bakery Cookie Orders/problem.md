...
## Description
A baker has a pantry of toppings (sprinkles, chips, etc.). They have orders for custom cookies. An order can be filled if the pantry has all the required toppings. Calculate the total topping count of all fillable orders.
