...
You are hosting a massive pizza party and need `t` pizzas. You have `n` friends who have agreed to help make them. Each friend `i` makes pizzas at their own pace, taking `k[i]` seconds per pizza. If everyone starts making pizzas at the same time, what is the minimum time you all need to wait to have at least `t` pizzas ready?
