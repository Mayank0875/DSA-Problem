...
## Description
Two inventory manifests list item IDs in storage order. A manager wants to find the longest continuous block of items that is stored in the same order in both warehouses. Calculate the size of this block.
