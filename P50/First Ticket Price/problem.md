...
## Description
A ticketing system lists available tickets sorted by price. A budget-conscious buyer wants to find the first ticket available at a specific price point. Given the sorted list of prices, return the index of the first ticket with the target price.
