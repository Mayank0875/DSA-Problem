...
## Description
A loading bar progresses in reverse to uninstall. It removes percentage points equal to any digit in the current percent.

The uninstall percent currently has a value of $n$. To complete uninstall, you must reduce this value exactly to $0$.
