...
## Description
An audio signal is processed as an array of amplitudes. Silence is represented by `0`. A compression algorithm removes silence by shifting all sound waves (non-zero) to the start of the sample window, pushing the silence to the end.
