...
## Description
A solar farm has `n` panels with specific wattage outputs. A power grid segment is stable if the connected panels' wattages have a GCD of 1.

Your task:
Count how many non-empty subsequences of panels have a greatest common divisor (GCD) of their wattages exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the wattages.
