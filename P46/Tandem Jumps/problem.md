...
## Description
A skydiving center logs jump IDs. A tandem jump involves an instructor and a student, logging the Jump ID twice. Solo jumps log once. Formation jumps log many times. The manifest needs to filter out the tandem jumps for insurance purposes. Return the Jump IDs appearing exactly twice.
