...
## Description
A router analyzes packet sizes. Packets with an even size are routed through a secure tunnel. As packets are padded or trimmed, calculate the total size of traffic flowing through the secure tunnel.
