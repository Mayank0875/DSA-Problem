...
## Description
An employee scheduling system logs shift codes. Employees working a 'double shift' are assigned the same shift code twice in a pay period. The payroll system needs to identify which shift codes were worked as double shifts to apply the correct overtime rate. Return these codes.
