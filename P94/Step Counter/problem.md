...
## Description
A fitness tracker counts down your step goal. You can log steps equal to any digit in the remaining goal.

The step goal currently has a value of $n$. To reach the target, you must reduce this value exactly to $0$.
