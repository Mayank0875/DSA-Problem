...
## Description
Sensors detect particulate matter. The official AQI is reported as a smoothed average over time to represent sustained exposure levels.

You are given a **0-indexed** array `nums` of `n` integers representing pollutant levels and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of pollutant levels.
