...
## Description
A submarine navigates a grid of underwater sectors. To avoid detection, it must pass through a specific sequence of terrain types. It moves between adjacent sectors. Check if the stealth path is viable.
