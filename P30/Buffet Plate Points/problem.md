...
You are at a buffet and want to build a plate with exactly $T$ "satisfaction points". There are $N$ different dishes, each giving a different number of points (e.g., 2, 3, 5). You can take an unlimited number of servings of any dish. Your task is to find the *total number* of unique combinations of dishes that will sum to $T$ points.
