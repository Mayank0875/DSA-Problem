...
## Description
A gardener has a tin of mixed seeds. They have plans for garden plots. A plot can be planted if the tin has all the specific seeds. Calculate the total seed count of all plantable plots.
