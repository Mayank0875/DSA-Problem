...
## Description
An editor reviews a manuscript and notes the page count of each chapter. For each chapter, they calculate a 'length span', defined as the number of consecutive preceding chapters (including the current one) that had fewer or equal pages. Given the list of page counts, calculate this span for each chapter.
