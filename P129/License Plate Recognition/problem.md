...
## Description
A camera system tries to match a partial plate number against a database of observed cars.

You are given two strings `target` and `source` consisting of alphanumeric characters.
...
- Strings consist of alphanumeric characters.
