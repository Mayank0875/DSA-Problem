...
In an experiment, a pressure reading spikes and then returns to normal. The `n` readings form a "mountain array":
    1. n >= 3
    2. `p[0] < p[1] < ... < p[i-1] < p[i]`
    3. `p[i] > p[i+1] > ... > p[n-1]`

Find the index of the moment of peak pressure.
