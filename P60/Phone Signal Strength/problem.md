...
## Description
A network map plots towers. Even tower indices are sorted by signal strength ascending. Odd tower indices are sorted by signal strength descending. Given the strength values, plot the map.
