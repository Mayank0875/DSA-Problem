...
## Description
A debugger lists active memory addresses in sorted order. A programmer needs to find the first reference to a specific memory address. Given the sorted list of addresses, find the index of the first occurrence of the target address.
