...
## Description
In a card game, the 'Final Flip' card instructs the player to reverse the order of their entire hand.

The data is stored as a string `s`. To reorder the hand, you must reverse the string.
