...
## Description
An image processing filter operates on pixels with an even brightness value. As you edit the image (adjusting pixel values), calculate the sum of brightness values for all pixels affected by the filter.
