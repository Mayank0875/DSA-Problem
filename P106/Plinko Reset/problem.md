...
## Description
A Plinko board is rotated to clear chips. Chips fall through pegs.
...
Rotating the board causes the entire grid to **rotate 90 degrees clockwise**. Following this rotation, gravity takes effect, causing the chips to fall downwards. Each chip falls until it lands on a peg, another chip, or the bottom boundary of the grid.

**Crucial Rules:**
1.  Gravity does not affect pegs; they are anchored in place relative to the grid structure.
2.  chips fall vertically in the new orientation.
...
#### Explanation
The grid rotates 90 degrees clockwise. The chips fall to the bottom.
...
#### Explanation
The pegs hold their relative positions. chips pile up on top of obstacles or the floor.
