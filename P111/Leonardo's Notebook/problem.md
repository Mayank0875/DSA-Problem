...
## Description
You found a page from da Vinci's notebook. He wrote in 'mirror script' (right to left) to keep his ideas secret.

The data is stored as a string `s`. To decipher the invention notes, you must reverse the string.
