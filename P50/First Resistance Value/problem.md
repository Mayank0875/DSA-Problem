...
## Description
An electronics inventory lists resistors sorted by their ohm value. An engineer needs to grab the first resistor bin that matches a specific resistance. Given the sorted list of resistance values, find the index of the first occurrence of the target value.
