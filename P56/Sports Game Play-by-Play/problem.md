...
## Description
Analysts compare the play-by-play logs (event codes) of two historical games. They look for the longest continuous sequence of events that happened exactly the same way in both games. Find the length of this event sequence.
