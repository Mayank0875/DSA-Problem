...
## Description
Air traffic control counts valid flight paths through a series of waypoints.

You are given two strings `target` and `source` consisting of waypoint IDs.
...
- Strings consist of waypoint IDs.
