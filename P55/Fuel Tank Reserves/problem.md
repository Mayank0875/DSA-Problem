...
## Description
A fleet of trucks has fuel tanks. Trucks with an even number of liters are flagged for a specific route. As trucks refuel or consume gas, calculate the total fuel available in all trucks currently flagged for that route.
