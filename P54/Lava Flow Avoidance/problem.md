...
## Description
A drone flies over a volcanic grid. It must survey a specific sequence of rock formations while staying close to the ground. It moves between adjacent grid points. Verify if the survey path can be flown.
