...
## Description
A birdwatcher corrects their log by deleting k sighting entries that were errors. Sightings are by Species ID. They suspect rare sightings were mistakes. By deleting k entries, what is the minimum number of unique species confirmed in the log?
