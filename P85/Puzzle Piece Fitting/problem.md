...
## Description
You have `n` puzzle pieces, each with a unique tab size. A section is completed if you fit together pieces whose tab sizes share no common factor greater than 1 (GCD is 1).

Your task:
Count how many non-empty subsequences of pieces have a greatest common divisor (GCD) of their tab sizes exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the tab sizes.
