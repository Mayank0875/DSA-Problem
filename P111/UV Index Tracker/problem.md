...
## Description
A wearable sensor tracks sun exposure. It calculates the average UV index to warn the user of sunburn risk.

You are given a **0-indexed** array `nums` of `n` integers representing UV indices and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of UV indices.
