...
In the ancient library of the Celestial Archive, a single crystal of the Echo of Infinity holds the knowledge of the ages. The archivist must create exactly n additional resonating crystals before the celestial alignment begins. Two resonance chambers are available. The first chamber can imbue a crystal with an echo in x seconds, and the second chamber does it in y seconds. Any existing crystal (original or newly created) can be placed in a chamber, and both chambers may operate simultaneously. Determine the minimum amount of time required to produce at least n new copies of the crystal, starting with just the original.
