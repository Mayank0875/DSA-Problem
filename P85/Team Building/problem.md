...
## Description
A manager has `n` employees with different skill ID numbers. A 'Universal Team' is formed if the selected employees' skill IDs have a GCD of 1.

Your task:
Count how many non-empty subsequences of employees have a greatest common divisor (GCD) of their skill IDs exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the skill IDs.
