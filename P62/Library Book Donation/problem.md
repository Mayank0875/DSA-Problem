...
## Description
A library is downsizing and must donate exactly k books. The books are identified by genre codes. The librarian wants to simplify the catalog by completely removing specific small genres. Determine the minimum number of unique genres left on the shelves.
