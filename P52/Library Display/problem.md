...
## Description
A librarian is creating a display of 'Hidden Gems'—books that are rarely borrowed. Books are identified by their ID. Arrange the books so that those with the fewest copies in the return pile come first. If the copy counts are equal, place the book with the higher ID first.
