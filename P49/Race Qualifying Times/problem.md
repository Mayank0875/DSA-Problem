...
## Description
In a racing qualification round, lap times are sorted from fastest (lowest) to slowest (highest). The organizers set a cut-off time. They need to find the index of the first racer whose time is greater than or equal to the cut-off to determine who is at risk of elimination.
