...
## Description
A Mars rover collects rock samples identified by type. Rare rock types need to be analyzed first. Sort the sample list so that rock types with the lowest counts come first. Ties are broken by the higher type ID.
