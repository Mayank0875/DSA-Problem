...
## Description
A librarian has a box of loose letters for spine labels. They have a list of book titles that need new labels. A label can be printed if the box contains all the letters for the title. Calculate the total characters of all printable labels.
