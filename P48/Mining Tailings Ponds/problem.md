...
## Description
A mine stores waste material in piles of varying heights. Rainwater forms toxic ponds in the depressions between these piles. Environmental engineers need to calculate the total volume of these ponds to manage overflow risk. Given the pile heights, compute the trapped volume.
