...
## Description
A warehouse tracks item turnover. A smoothed average of daily shipments helps purchasing managers avoid stockouts.

You are given a **0-indexed** array `nums` of `n` integers representing shipment counts and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of shipment counts.
