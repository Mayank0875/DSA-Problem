...
## Description
A used car dealership lists cars sorted by manufacturing year. A buyer is looking for the first car in the list from a specific year. Given the sorted list of years, return the index of the first occurrence of the target year.
