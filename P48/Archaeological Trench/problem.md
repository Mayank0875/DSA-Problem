...
## Description
An archaeological dig site consists of a series of parallel trench walls of varying heights. Heavy rain fills the spaces between walls. To protect the artifacts, the team needs to pump out the water. Calculate the total volume of water trapped in the site given the wall heights.
