...
## Description
A probe scans a planet's magnetic field. To filter out interference, the data is smoothed by averaging adjacent readings.

You are given a **0-indexed** array `nums` of `n` integers representing field strengths and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of field strengths.
