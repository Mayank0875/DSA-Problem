...
## Description
An economist is reviewing historical mortgage interest rates week by week. For each week's rate, they want to identify the rate of the nearest future week that was strictly lower. This helps in analyzing rate cut cycles. Given the list of weekly interest rates, find the next lower rate for each week. If rates never dropped below the current level in the future, report -1.
