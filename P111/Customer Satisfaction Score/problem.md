...
## Description
A feedback system receives ratings. To track team performance, the system calculates a centered average of ratings received.

You are given a **0-indexed** array `nums` of `n` integers representing ratings and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of ratings.
