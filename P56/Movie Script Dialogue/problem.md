...
## Description
A script doctor compares two drafts of a screenplay (lines hashed to integers). They want to find the longest continuous scene of dialogue that remains unchanged. Find the number of lines in this scene.
