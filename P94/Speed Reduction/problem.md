...
## Description
A runaway train needs to stop. The emergency brakes reduce speed by km/h equal to any digit in the current speedometer reading.

The train speed currently has a value of $n$. To stop the train, you must reduce this value exactly to $0$.
