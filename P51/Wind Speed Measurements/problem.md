...
## Description
A wind turbine records wind speed every ten minutes. For each reading, the system calculates a 'velocity span': the number of consecutive previous readings (including the current one) where the wind speed was less than or equal to the current speed. Given the wind speed logs, calculate this span.
