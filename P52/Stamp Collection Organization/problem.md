...
## Description
A philatelist is arranging stamps in an album. The stamps are identified by their series number. The goal is to display the rarest stamps (fewest duplicates) at the beginning. If two series have the same number of stamps, the series with the higher number is considered more prestigious and goes first.
