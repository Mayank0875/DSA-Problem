...
## Description
A garden is divided into a grid of flower beds, each labeled by the type of flower. A visitor wants to take a walk encountering a specific sequence of flowers. They can only walk between adjacent beds. Check if such a walk is possible.
