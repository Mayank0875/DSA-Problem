...
## Description
A data center monitors server loads. Servers with an even load percentage are considered to be in 'maintenance mode'. As traffic shifts, increasing or decreasing the load on specific servers, you need to calculate the total load of all servers currently in maintenance mode after each traffic update.
