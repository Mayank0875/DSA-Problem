...
## Description
A program crashed. The error log shows the call stack, but to trace the origin, you need to read the function calls from the bottom up.

The data is stored as a string `s`. To trace the crash origin, you must reverse the string.
