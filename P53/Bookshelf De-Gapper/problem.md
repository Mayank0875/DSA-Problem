...
## Description
A digital e-reader shelf shows book covers (IDs) and blank spaces (`0`). The user presses 'Sort', and the software slides all books to the beginning of the grid, pushing blank spaces to the end.
