...
## Description
A farmer plants trees. Even rows have trees sorted by age ascending. Odd rows have trees sorted by age descending. Given the ages of the saplings, determine the planting schedule.
