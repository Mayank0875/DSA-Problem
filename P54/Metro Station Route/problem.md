...
## Description
A city's metro zones are laid out in a grid. A tourist wants to visit a specific sequence of zones. They can only travel between adjacent zones. Given the grid of zone codes, determine if their itinerary is feasible.
