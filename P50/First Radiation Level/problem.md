...
## Description
A safety monitor records radiation levels sorted by intensity. An inspector needs to find the first timestamp index where the radiation was exactly a specific value. Given the sorted levels, find the index of the first occurrence of the target.
