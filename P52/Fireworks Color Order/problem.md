...
## Description
A pyrotechnician arranges fireworks by color code. Rare colors should be fired first for impact. If the count of fireworks is the same for two colors, the one with the higher code is fired first.
