...
## Description
A textile machine reads two fabric designs as sequences of color codes. It needs to find the longest continuous strip of pattern that is identical in both fabrics. Determine the length of this matching pattern strip.
