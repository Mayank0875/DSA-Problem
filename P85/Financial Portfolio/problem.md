...
## Description
An investor looks at `n` stocks, each with a risk factor ID. A diversified portfolio consists of stocks where the GCD of their risk IDs is 1.

Your task:
Count how many non-empty subsequences of stocks have a greatest common divisor (GCD) of their risk IDs exactly equal to 1.
...
- The second line contains n integers $a_1, a_2, \dots, a_n$ representing the risk IDs.
