...
## Description
Hikers follow trail markers laid out in a grid pattern on trees. A guidebook lists a specific hike as a sequence of marker symbols. Hikers move between adjacent trees. Determine if the hike exists in this forest.
