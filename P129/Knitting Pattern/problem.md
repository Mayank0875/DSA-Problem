...
## Description
A knitter checks if a complex stitch pattern exists within a row of stitches.

You are given two strings `target` and `source` consisting of stitch types.
...
- Strings consist of stitch types.
