...
## Description
A central bank publishes a list of historical interest rates sorted by value. An economist wants to study the periods when rates were high. They provide a threshold value and need to find the index of the first historical record where the rate was greater than or equal to this threshold.
