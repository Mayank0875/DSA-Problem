...
## Description
In a robot army, units with an even power level are assigned to the defense squad. As upgrades or damages modify the power levels of specific robots, calculate the total power of the current defense squad.
