...
## Description
A sci-fi cargo needs to lose mass for warp travel. The mass reducer removes kg equal to any digit in the current mass.

The cargo mass currently has a value of $n$. To reach zero mass state, you must reduce this value exactly to $0$.
