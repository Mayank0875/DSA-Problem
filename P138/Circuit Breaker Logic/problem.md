...
## Description
An engineer designs a breaker $x$. It trips for loads $y$ unless the interference (XOR) divides the load or capacity.

The engineer defines a specific relationship between a fixed integer $x$ and a candidate integer $y$. A value $y$ is considered "**safe**" with $x$ if:
