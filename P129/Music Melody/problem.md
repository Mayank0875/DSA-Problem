...
## Description
A composer wants to know how many times a specific melody motif appears in a long symphony score.

You are given two strings `target` and `source` consisting of musical notes 'A'-'G'.
...
- Strings consist of musical notes 'A'-'G'.
