...
## Description
Two shipping routes are logged as sequences of distribution center IDs. A logistics planner wants to find the longest continuous leg where both shipments followed the same path. Calculate the number of centers in this shared leg.
