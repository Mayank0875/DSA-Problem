...
## Description
A designer removes k components to simplify a game. Components are by type ID. They remove the unique/rare tokens first. Determine the minimum number of unique component types remaining.
