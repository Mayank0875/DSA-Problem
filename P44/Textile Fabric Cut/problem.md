...
## Description
A textile factory has a scrap piece of fabric with a jagged edge. The fabric can be modeled as a series of attached vertical strips of different heights. You need to cut out the largest possible rectangular piece of fabric from this scrap to minimize waste. Given the heights of the strips, find the area of this largest rectangle.
