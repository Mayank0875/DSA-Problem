...
## Description
Climbers tie two ropes together to rappel. The total length must equal the descent distance. Given a pile of rope segments, count the pairs that provide the exact length needed.
