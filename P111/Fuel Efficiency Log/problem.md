...
## Description
A car computer tracks MPG. To display a stable number, it averages the efficiency over the last few kilometers driven.

You are given a **0-indexed** array `nums` of `n` integers representing MPG readings and an integer `k`.
...
## Input Format
- The first line contains an integer `n`, representing the number of MPG readings.
