...
## Description
A satellite captures a grid of terrain types. Intelligence seeks a specific convoy route matching a sequence of terrains. The convoy moves between adjacent sectors. Check if the route is visible in the scan.
