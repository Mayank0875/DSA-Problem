...
## Description
A robot parses a corrupted command stream to execute a specific 'Move-Grab-Drop' sequence.

You are given two strings `target` and `source` consisting of command codes.
...
- Strings consist of command codes.
